# Multica — AI Agent Context

> **Primary context file for Multica agents.** This file is the authoritative source
> for architecture, conventions, commands, and coding rules when working in this repository.
> All other context files (CLAUDE.md, AGENTS.md) reference this document.
