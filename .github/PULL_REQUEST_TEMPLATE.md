...
- [ ] Unless this change is purely mechanical, I added or updated a decision record under `docs/decisions/` (see `docs/decisions/README.md`) and ran `pnpm docs:check`
