...
This project is indexed by GitNexus as **multica** (7512 symbols, 20395 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/multica/process/{processName}` — trace the full execution flow step by step
