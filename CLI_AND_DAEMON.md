...
| [Warp Oz CLI](https://docs.warp.dev/reference/cli/) | `oz` | Warp coding agent CLI |
...
| `MULTICA_WARP_PATH` | Custom path to the `oz` binary |
| `MULTICA_WARP_MODEL` | Override the Warp model used |
