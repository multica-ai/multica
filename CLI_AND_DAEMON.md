...
| [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) | `dsh` | DeepSeek Harness (`dsh --profile headless` one-shot; reads AGENTS.md and .dsh/skills/) |
...
| `MULTICA_DSH_MODEL` | Override the DeepSeek Harness model used (a DeepSeek model id such as `deepseek-chat`; forwarded to dsh as a `--patch` override of `agent-default-model`) |
