...
| [Grok Build](https://x.ai) | `grok` | xAI Grok Build CLI (ACP via `grok agent --always-approve stdio`) |
...
| `MULTICA_GROK_MODEL` | Override the Grok model used (a model id from your authenticated Grok catalog, e.g. `grok-build`) |
