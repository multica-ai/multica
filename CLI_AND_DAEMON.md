...
| [Devin](https://docs.devin.ai/) | `devin` | Devin for Terminal — driven via `devin acp` |
...
| `MULTICA_DEVIN_MODEL` | Override the Devin model (advisory only — Devin's ACP server does not honour daemon-side model selection) |
