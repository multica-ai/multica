...
type Metrics interface {
	...
	// outcome. A shed reply moves both: this one because it is an admission
	// decision, and outbound_dropped because a reply nobody receives is a
	// dropped reply whatever refused it.
