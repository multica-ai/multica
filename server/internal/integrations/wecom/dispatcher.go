...
func (d *Dispatcher) scheduleRun(inst db.WecomInstallation, msg InboundMessage, sessionID pgtype.UUID) {
...
func (d *Dispatcher) flushChatRun(inst db.WecomInstallation, msg InboundMessage, sessionID pgtype.UUID) {
