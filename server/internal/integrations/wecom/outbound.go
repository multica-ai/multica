...
//
// Inbox pushes are no longer subscribed here: the notify package owns that
// subscription and the whitelist/rendering decision, and calls back into
// this adapter's DeliverDM (notify_dm.go) only for the send.
