...
func TestSessionBinder_StartSessionMapsWeComRouteAndFirstTurn(t *testing.T) {
	...
	got := fb.startIn
	if got.BindingKey != "GROUP_1:TUSER_A" || got.Body != "first turn" || got.CommandText != "current instruction" || got.MessageID != "m1" || got.ClaimToken != claim || got.MediaPendingSeconds != 45 || !got.PersistMessage {
