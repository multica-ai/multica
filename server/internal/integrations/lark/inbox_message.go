...
// inboxCardParts are the composable pieces of one notification: the digest
// path stitches several events' parts into a single growing card, while a
// standalone card is just header + body + link.
...
// body, any digested follow-up blocks separated by rules, and one 查看详情
// line at the bottom.
