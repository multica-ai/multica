...
// obtain an im_token + ws_url, opens an im.Socket, and bridges inbound messages
// until the context is cancelled. Reconnect/backoff is handled inside im.Socket.
type socketConnector struct {
	installations *InstallationService
	logger        *slog.Logger
}

// NewConnectorFactory returns a ConnectorFactory backed by im.Socket. The
...
func (c *socketConnector) Run(ctx context.Context, inst db.OctoInstallation, onMessage func(im.BotMessage)) error {
