...
type Task struct {
	...
	IntegrationBindings      []IntegrationBindingData `json:"integration_bindings,omitempty"`        // Workspace connections explicitly bound to this task's Space; metadata only
