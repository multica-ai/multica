...
type Task struct {
	...
	LeaderRoleResolved            bool                   `json:"leader_role_resolved,omitempty"`             // server capability: IsLeaderTask/SquadID authoritatively answer "is this a leader run". Absent on servers predating it (they never sent is_leader_task on claim either), where taskIsSquadLeader falls back to the briefing marker (MUL-5811)
