...
func buildQuickCreatePrompt(task Task) string {
	...
	b.WriteString("     - **Meta-instructions to the issue-creating agent itself.** Phrases addressed to you about how to create the issue: \"create an issue / ticket\", \"open a ticket\", \"记一下\", \"帮我建个 issue\", \"assign to X\", \"分配给 X\", \"cc @Y\". These are routing instructions handled by other CLI flags (`--assignee`, etc.); the user's underlying intent stays, only the routing wrapper goes.\n")
