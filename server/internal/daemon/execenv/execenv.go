...
type PrepareParams struct {
	...
	CodexPath      string // path to the Codex executable
...
func Prepare(params PrepareParams, logger *slog.Logger) (*Environment, error) {
	...
	if params.Provider == "codex" {
		...
		if err := prepareCodexHomeWithOpts(codexHome, CodexHomeOptions{CodexVersion: params.CodexVersion, CodexPath: params.CodexPath}, logger); err != nil {
