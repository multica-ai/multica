...
func TestPrepareWithProjectResources(t *testing.T) {
	...
	taskCtx := TaskContextForEnv{
		...
		ProjectDescription: "Ship the agent UX dashboard and keep rollout notes in this project.",
	...
	for _, want := range []string{
		...
		"Agent UX 2026",
		"Project description:",
		"Ship the agent UX dashboard and keep rollout notes in this project.",
		"GitHub repo",
