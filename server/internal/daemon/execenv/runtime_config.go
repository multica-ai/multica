...
// For ZCode:       writes {workDir}/AGENTS.md  (zcode-cli reads AGENTS.md natively; skills discovered natively from .zcode/skills/)
...
func runtimeConfigPath(workDir, provider string) string {
	...
	case "codex", "copilot", "opencode", "deveco", "openclaw", "hermes", "pi", "cursor", "kimi", "reasonix", "dsh", "kiro", "antigravity", "qoder", "qoderclicn", "traecli", "grok", "qwenpaw", "zcode":
