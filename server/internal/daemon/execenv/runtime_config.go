...
// For DSH:         writes {workDir}/AGENTS.md  (DeepSeek Harness reads AGENTS.md natively via dsh-agent-instructions)
...
func runtimeConfigPath(workDir, provider string) string {
	...
	case "codex", "copilot", "opencode", "deveco", "openclaw", "hermes", "pi", "cursor", "kimi", "reasonix", "kiro", "antigravity", "qoder", "qoderclicn", "traecli", "grok", "qwenpaw", "dsh":
