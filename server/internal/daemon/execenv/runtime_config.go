...
// For Reasonix: writes {workDir}/AGENTS.md  (Reasonix reads AGENTS.md natively; skills auto-discovered from .reasonix/skills/)
func InjectRuntimeConfig(workDir, provider string, ctx TaskContextForEnv) (string, error) {
	...
	case "codex", "copilot", "opencode", "openclaw", "hermes", "pi", "cursor", "kimi", "kiro", "reasonix":
...
func buildMetaSkillContent(provider string, ctx TaskContextForEnv) string {
	...
	if len(ctx.AgentSkills) > 0 {
		...
		case "codex", "copilot", "opencode", "openclaw", "pi", "cursor", "kimi", "kiro", "reasonix":
