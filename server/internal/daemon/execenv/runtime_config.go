...
// For Cursor:   writes {workDir}/AGENTS.md  (skills under .cursor/skills/)
...
func buildMetaSkillContent(provider string, ctx TaskContextForEnv) string {
	...
	if len(ctx.AgentSkills) > 0 {
		...
		case "codex", "opencode", "openclaw", "cursor":
			// Codex, OpenCode, OpenClaw, and Cursor discover skills from their native paths — just list names.
			b.WriteString("You have the following skills installed (discovered automatically):\n\n")
		default:
