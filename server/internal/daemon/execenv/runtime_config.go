...
// For Trae CLI: writes {workDir}/AGENTS.md  (Trae CLI reads AGENTS.md natively; skills auto-discovered from .trae/skills/)
...
func buildMetaSkillContent(provider string, ctx TaskContextForEnv) string {
	...
	if len(ctx.AgentSkills) > 0 {
		...
		case "codex", "copilot", "opencode", "openclaw", "pi", "cursor", "kimi", "kiro", "traecli":
			// Codex, Copilot, OpenCode, OpenClaw, Pi, Cursor, Kimi, Kiro, and Trae CLI discover skills
