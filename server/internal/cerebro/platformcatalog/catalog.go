...
var catalog = []Capability{
	...
	},
	{
		...
		Title:         "Manage apps",
		Category:      CategoryApps,
		Description:   "Preview, publish, retry, roll back, and approve scopes for workspace apps.",
		DescriptionZh: "预览、发布、重试、回滚并批准工作区应用的权限范围。",
		Ops: []string{
			...
			"POST /api/cerebro/apps/{id}/retry-deployment",
	...
	},
	{
		...
		Title:         "Delete apps",
		Category:      CategoryApps,
		Description:   "Delete an app and all of its versions and app-owned data.",
	...
	},
	{
		...
		Ops: []string{
			...
			"POST /api/cerebro/vision-plan/pages",
			"PUT /api/cerebro/vision-plan/pages/{id}",
			"DELETE /api/cerebro/vision-plan/pages/{id}",
...
var excluded = map[string]string{
	...
	"POST /api/daemon/tasks/{taskId}/hook-events":                                  "daemon-token — runtime daemon callback",
