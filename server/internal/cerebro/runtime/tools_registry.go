...
var multicaMCPToolMatrix = []ToolMeta{
	...
	{Name: "skill_get_observations", Description: "List recorded observations for a skill.", Status: ToolStatusExcluded},
	...
	{Name: "skill_record_observation", Description: "Record an observation about a skill.", Status: ToolStatusExcluded},
