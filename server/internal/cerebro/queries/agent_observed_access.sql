...
mandate_denials AS (
    ...
    WHERE agent_id = sqlc.arg(agent_id)
      AND reason_code IN ('task_mandate_missing', 'task_mandate_expired', 'task_identity_mismatch', 'task_generation_stale', 'task_tool_not_authorized', 'task_finalization_conflict', 'task_mandate_internal_error')
