...
import (
	...
	"github.com/wallts-ai/wallts/server/internal/mention"
...
// `wallts issue create` call. Pre-validates that the agent is reachable
...
// manual `wallts agent update <id> --status idle` to unwedge. Matches the
...
// daemon-injected WALLTS_QUICK_CREATE_TASK_ID env var, so this lookup is
