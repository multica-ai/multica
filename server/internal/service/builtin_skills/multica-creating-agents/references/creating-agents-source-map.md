...
|---|---|---|
| Persisted mode and selected-Space relation | `migrations/201_agent_space_availability.up.sql` | Adds constrained `agent.availability_mode` plus workspace-consistent `agent_available_space`; legacy public agents backfill to workspace and private agents stay private |
