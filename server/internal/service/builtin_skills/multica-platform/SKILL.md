...
description: "Use for Multica platform actions the runtime brief does not fully cover: issue and PR contracts, mentions, agents, squads, autopilots, projects, runtimes, workflows, knowledge bases, skill import. Not for the product code you are working on."
...
| `references/workflows.md` | Agent workflow nodes: inputs, outputs, execution boundaries and retries |
| `references/knowledge.md` | Read-only knowledge-base search, chunk reads, entities and graph queries |
