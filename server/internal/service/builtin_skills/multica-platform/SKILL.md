...
|---|---|
| `references/issues.md` | Issues: PR linking and auto-complete, reading a linked PR's state, custom properties, status side effects, sub-issues and stages, who else is running, event/time wakeups, charts vs attached files in a comment |
