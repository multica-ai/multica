...
2. **Delegate by @mention.** Post a single comment on this issue that
   ...
   - **Be terse.** Every Wallts agent already has full context of the
...
3. **Record your evaluation.** After every trigger — whether you delegated,
   ...
   ` + "`" + `wallts squad activity <issue-id> <outcome> --reason "<short reason>"` + "`" + `
...
- ALWAYS call ` + "`" + `wallts squad activity` + "`" + ` before ending your turn —
