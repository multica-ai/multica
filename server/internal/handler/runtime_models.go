...
const (
	...
	// modelListStoreRetention is the Redis TTL for individual model-list
	// request records. It must be longer than the running timeout so the
	// record survives long enough for the UI to poll it.
