...
var workspaceDeletionManifest = map[string]workspaceDeleteAction{
	...
	"knowledge_base":                     workspaceDelete,
	"knowledge_chunk":                    workspaceDelete,
	"knowledge_document":                 workspaceDelete,
	"knowledge_document_version":         workspaceDelete,
	"knowledge_embedding":                workspaceDelete,
	"knowledge_entity":                   workspaceDelete,
	"knowledge_entity_alias":             workspaceDelete,
	"knowledge_evidence":                 workspaceDelete,
	"knowledge_extraction_run":           workspaceDelete,
	"knowledge_graph_edit":               workspaceDelete,
	"knowledge_index":                    workspaceDelete,
	"knowledge_job":                      workspaceDelete,
	"knowledge_model_binding":            workspaceDelete,
	"knowledge_model_capability":         workspaceDelete,
	"knowledge_model_settings":           workspaceDelete,
	"knowledge_provider":                 workspaceDelete,
	"knowledge_relation":                 workspaceDelete,
	"knowledge_request":                  workspaceDelete,
	...
	"workflow":                           workspaceDelete,
	"workflow_chat":                      workspaceDelete,
	"workflow_chat_turn":                 workspaceDelete,
	...
	"workflow_outbox":                    workspaceDelete,
	"workflow_output":                    workspaceDelete,
	"workflow_release":                   workspaceDelete,
	"workflow_run":                       workspaceDelete,
	"workflow_scope_instance":            workspaceDelete,
	"workflow_transition":                workspaceDelete,
	"workflow_version":                   workspaceDelete,
	"workflow_work_item":                 workspaceDelete,
}
