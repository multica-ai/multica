...
var workspaceDeletionManifest = map[string]workspaceDeleteAction{
	...
	"automation_state":                workspaceDelete,
	...
	"hook":                            workspaceDelete,
	"hook_action_effect":              workspaceDelete,
	"hook_execution":                  workspaceDelete,
	"hook_revision":                   workspaceDelete,
