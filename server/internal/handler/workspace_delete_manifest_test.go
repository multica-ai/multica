...
var workspaceDeletionManifest = map[string]workspaceDeleteAction{
	...
	// A global singleton holding the rollout switch, not tenant data: it has no
	// workspace_id and must outlive any workspace deletion.
	"inbox_v2_cutover":               workspaceDeleteKeep,
