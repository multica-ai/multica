...
var workspaceDeletionManifest = map[string]workspaceDeleteAction{
	...
	"agent_tool_action_event":            workspaceDelete,
	"agent_tool_approval_request":        workspaceDelete,
	"agent_tool_policy":                  workspaceDelete,
	"agent_tool_policy_revision":         workspaceDelete,
	"agent_tool_policy_rule":             workspaceDelete,
