...
const (
	...
	deliverySnapshotTable = "agent_task_comment_delivery_snapshot"
)
...
var workspaceDeletionManifest = map[string]workspaceDeleteAction{
	...
	deliverySnapshotTable:                workspaceDelete,
	"agent_task_queue":                   workspaceDelete,
	"agent_task_completion_outcome":      workspaceDelete,
	...
	"comment_create_request":             workspaceDelete,
	"comment_reaction":                   workspaceDelete,
	"comment_trigger_delivery_receipt":   workspaceDelete,
	"comment_trigger_outbox":             workspaceDelete,
	...
	"lifeos_local_credential":            workspaceDeleteKeep,
	"lifeos_secretary_instruction":       workspaceDelete,
	"lifeos_secretary_projection":        workspaceDelete,
	"issue":                              workspaceDelete,
	"issue_create_request":               workspaceDelete,
	...
	"task_completion_outbox":             workspaceDelete,
