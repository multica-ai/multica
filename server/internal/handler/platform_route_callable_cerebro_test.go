...
func TestExactPlatformCallableCannotSpoofAnotherOperationInFamily(t *testing.T) {
	tests := []struct {
		...
		{name: "issue rerun exact", method: http.MethodPost, path: "/api/issues/abc/rerun", capability: "rerun_issue", callable: "rerun_issue", want: true},
		{name: "issue subscribe exact", method: http.MethodPost, path: "/api/issues/abc/subscribe", capability: "subscribe_issue", callable: "subscribe_issue", want: true},
		{name: "issue unsubscribe exact", method: http.MethodPost, path: "/api/issues/abc/unsubscribe", capability: "subscribe_issue", callable: "subscribe_issue", want: true},
		{name: "issue reaction add exact", method: http.MethodPost, path: "/api/issues/abc/reactions", capability: "subscribe_issue", callable: "subscribe_issue", want: true},
		{name: "issue reaction remove exact", method: http.MethodDelete, path: "/api/issues/abc/reactions", capability: "subscribe_issue", callable: "subscribe_issue", want: true},
