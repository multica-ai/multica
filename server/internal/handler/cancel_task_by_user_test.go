...
func createWorkspaceMemberUserWithEmail(t *testing.T, name, email string) string {
	t.Helper()
	ctx := context.Background()
...
func TestCancelTaskByUser_ChatTask_NonCreator_Returns403(t *testing.T) {
	...
	otherUserID := createWorkspaceMemberUserWithEmail(t, "Chat Bystander", "cancel-chat-bystander@multica.test")
