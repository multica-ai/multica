...
从下面选一个开始，或者直接告诉我你现在想做成什么。`,
	...
	"zh-Hant": `你好，歡迎來到 %[1]s。Multica 是一個讓人與 AI 智慧體透過任務協作、完成實際工作的空間。

我是 %[2]s，這裡的 Chief of Staff。我會釐清待辦事項、交由合適的 AI 智慧體處理，也是你隨時都能開口的第一站。

接下來很簡單：告訴我一個目標，我會將它轉化為任務，交給合適的 AI 智慧體開始執行；你可以全程掌握進度。

從下方選一項開始，或直接告訴我你現在想完成什麼。`,
