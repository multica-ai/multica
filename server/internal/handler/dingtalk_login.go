...
//
// Requires MULTICA_DINGTALK_AUTH_CLIENT_ID / MULTICA_DINGTALK_AUTH_CLIENT_SECRET.
...
func (h *Handler) DingTalkLogin(w http.ResponseWriter, r *http.Request) {
	...
	clientID := os.Getenv("MULTICA_DINGTALK_AUTH_CLIENT_ID")
	clientSecret := os.Getenv("MULTICA_DINGTALK_AUTH_CLIENT_SECRET")
