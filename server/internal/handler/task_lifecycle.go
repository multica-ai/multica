...
// server-side running timeout (2.5h by default) to notice such tasks; the
// daemon itself knows the moment it comes back up, so we let it report orphan recovery.
