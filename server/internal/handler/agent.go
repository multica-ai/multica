...
func (h *Handler) CreateAgent(w http.ResponseWriter, r *http.Request) {
	...
	normalizedModel, err := agent.NormalizeModelForProvider(runtime.Provider, req.Model)
	if err != nil {
...
func (h *Handler) UpdateAgent(w http.ResponseWriter, r *http.Request) {
	...
	if req.Model != nil {
		...
		normalizedModel, err := agent.NormalizeModelForProvider(provider, *req.Model)
		if err != nil {
			writeError(w, http.StatusBadRequest, err.Error())
			return
		}
		params.Model = pgtype.Text{String: normalizedModel, Valid: true}
