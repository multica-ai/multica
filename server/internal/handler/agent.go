...
type AgentTaskResponse struct {
	...
	NewCommentCount         int                  `json:"new_comment_count,omitempty"`         // issue-wide comments since last run; excludes injected trigger + own comments; omitempty so old daemons ignore it
