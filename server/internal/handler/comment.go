...
// emitted via the X-Wallts-Next-Before / X-Wallts-Next-Before-Id
// response headers.
//
...
func (h *Handler) ListComments(w http.ResponseWriter, r *http.Request) {
	...
	if result.NextBefore != "" && result.NextBeforeID != "" {
		w.Header().Set("X-Wallts-Next-Before", result.NextBefore)
		w.Header().Set("X-Wallts-Next-Before-Id", result.NextBeforeID)
	}
