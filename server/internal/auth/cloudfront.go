...
type CloudFrontSigner struct {
	...
	domain       string // CDN domain, e.g. "static.wallts.ai"
	cookieDomain string // cookie scope, e.g. ".wallts.ai"
}
...
//   - CLOUDFRONT_DOMAIN       (e.g. "static.wallts.ai")
//   - COOKIE_DOMAIN           (e.g. ".wallts.ai")
