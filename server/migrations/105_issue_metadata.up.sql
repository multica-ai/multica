...
ALTER TABLE issue ADD COLUMN IF NOT EXISTS metadata JSONB NOT NULL DEFAULT '{}'::jsonb;
...
CREATE INDEX IF NOT EXISTS idx_issue_metadata_gin ON issue USING GIN (metadata jsonb_path_ops);
