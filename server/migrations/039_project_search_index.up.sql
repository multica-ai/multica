...
DO $$
BEGIN
  CREATE INDEX IF NOT EXISTS idx_project_title_bigm ON project USING gin (LOWER(title) gin_bigm_ops);
  CREATE INDEX IF NOT EXISTS idx_project_description_bigm ON project USING gin (LOWER(COALESCE(description, '')) gin_bigm_ops);
