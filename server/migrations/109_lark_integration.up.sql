...
CREATE INDEX IF NOT EXISTS idx_lark_installation_workspace ON lark_installation(workspace_id);
CREATE INDEX IF NOT EXISTS idx_lark_installation_agent ON lark_installation(agent_id);
-- Used by the lease scanner to find leases due for renewal / takeover.
CREATE INDEX IF NOT EXISTS idx_lark_installation_lease ON lark_installation(ws_lease_expires_at)
    WHERE status = 'active';
...
CREATE INDEX IF NOT EXISTS idx_lark_user_binding_user
    ON lark_user_binding(multica_user_id, workspace_id);
CREATE INDEX IF NOT EXISTS idx_lark_user_binding_workspace_open
...
CREATE INDEX IF NOT EXISTS idx_lark_chat_session_binding_session
...
CREATE INDEX IF NOT EXISTS idx_lark_inbound_dedup_received
...
CREATE INDEX IF NOT EXISTS idx_lark_inbound_audit_installation
    ON lark_inbound_audit(installation_id, received_at DESC);
CREATE INDEX IF NOT EXISTS idx_lark_inbound_audit_reason
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_lark_outbound_card_task
    ON lark_outbound_card_message(task_id)
    WHERE task_id IS NOT NULL;
CREATE INDEX IF NOT EXISTS idx_lark_outbound_card_session
...
CREATE INDEX IF NOT EXISTS idx_lark_binding_token_installation
