...
DECLARE
    ...
    first_ws_id UUID;
BEGIN
    SELECT id INTO first_ws_id FROM multica_workspace LIMIT 1;
    IF first_ws_id IS NOT NULL AND NOT EXISTS (
        SELECT 1 FROM multica_workflow WHERE is_template = TRUE AND title = 'AI Coding 全链路'
    ) THEN
        ...
        INSERT INTO multica_workflow_node (workflow_id, title, description, position_x, position_y, format_schema, worker_type, worker_instructions, critic_type, critic_instructions, sort_order)
        ...
        INSERT INTO multica_workflow_edge (workflow_id, source_node_id, target_node_id) VALUES (tmpl_id, n1, n2);
        INSERT INTO multica_workflow_edge (workflow_id, source_node_id, target_node_id) VALUES (tmpl_id, n2, n3);
        INSERT INTO multica_workflow_edge (workflow_id, source_node_id, target_node_id) VALUES (tmpl_id, n3, n4);
        INSERT INTO multica_workflow_edge (workflow_id, source_node_id, target_node_id) VALUES (tmpl_id, n4, n5);
    END IF;
END $$;
