...
-- CEREBRO-PATCH(migration-079-github-integration): make upstream migration idempotent for fork deploy retries.
...
CREATE INDEX IF NOT EXISTS idx_github_installation_workspace ON github_installation(workspace_id);
...
CREATE INDEX IF NOT EXISTS idx_github_pull_request_workspace ON github_pull_request(workspace_id);
...
CREATE INDEX IF NOT EXISTS idx_issue_pull_request_pr ON issue_pull_request(pull_request_id);
