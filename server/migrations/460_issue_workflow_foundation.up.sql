-- Additive Issue Workflow domain foundation (MUL-7022).
--
...
CREATE TABLE issue_workflow_status (
    id UUID NOT NULL DEFAULT gen_random_uuid(),
    workspace_id UUID NOT NULL,
    ...
    created_at TIMESTAMPTZ NOT NULL DEFAULT now(),
    updated_at TIMESTAMPTZ NOT NULL DEFAULT now(),
    CONSTRAINT issue_workflow_status_entry_policy_object
...
ALTER TABLE workspace ADD COLUMN default_issue_workflow_id UUID;
ALTER TABLE project ADD COLUMN default_issue_workflow_id UUID;
ALTER TABLE issue ADD COLUMN workflow_id UUID;
ALTER TABLE issue ADD COLUMN workflow_status_id UUID;
