...
-- 500 is above every version currently on main.  440, 441, 444, 446, 451,
-- 457, 468 and 491 were each free when this migration was renumbered onto them,
-- and each was then taken: 440 by 440_github_pr_head_sha_index (#7695), 441
-- by 441_runtime_profile_add_codearts (#6985), 444 by
...
-- 468_drop_reference_only_column (#8253), and 491 by
-- 491_issue_status_category_backfill (#8466).  main now reaches 499, so 500 is
-- the next free prefix.  None of 442-499 is a family migration, so 441
