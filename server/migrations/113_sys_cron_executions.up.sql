...
CREATE INDEX IF NOT EXISTS idx_sys_cron_exec_job_plan
...
CREATE INDEX IF NOT EXISTS idx_sys_cron_exec_running_stale
...
CREATE INDEX IF NOT EXISTS idx_sys_cron_exec_failed_recent
...
-- policy.
CREATE INDEX IF NOT EXISTS idx_sys_cron_exec_finished
