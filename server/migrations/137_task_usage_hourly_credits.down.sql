...
-- we can revert it.
--
-- The reseeded watermark is intentionally NOT reset in the down migration:
-- an operator rolling back has already accepted a possibly-slow catch-up
-- as part of the forward migration, and cost is bounded by the 1-day
-- LEAST cap in `rollup_task_usage_hourly` (see migration 102).
