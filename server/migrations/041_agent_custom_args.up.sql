-- CEREBRO-PATCH(migration-idempotent-041-agent-custom-args): cerebro modification of upstream file
...
ALTER TABLE agent ADD COLUMN IF NOT EXISTS custom_args JSONB NOT NULL DEFAULT '[]';
