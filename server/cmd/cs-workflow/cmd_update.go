...
var updateCmd = &cobra.Command{
	Use:   "update",
	Short: "Update cs-workflow to the latest version",
	RunE:  runUpdate,
}
...
func runUpdate(_ *cobra.Command, _ []string) error {
	...
	if latest == nil {
		return fmt.Errorf("could not determine latest version; check https://github.com/Askhz/multica/releases/latest")
	}
