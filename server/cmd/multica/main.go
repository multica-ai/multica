...
func init() {
	...
	artifactCmd.GroupID = groupAdditional
	...
	orchestrateCmd.GroupID = groupCore // CEREBRO-PATCH(cerebro-orchestration): FIR-2564
	sprintCmd.GroupID = groupCore      // CEREBRO-PATCH(cerebro-sprints-cli): FIR-2718
	...
	appCmd.GroupID = groupCore         // CEREBRO-PATCH(cerebro-mini-apps-cli): FIR-3172
	...
	rootCmd.AddCommand(appCmd)         // CEREBRO-PATCH(cerebro-mini-apps-cli): FIR-3172
