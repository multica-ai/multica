...
func init() {
	...
	propertyCreateCmd.Flags().String("icon", "", "Property icon (for example, an emoji)")
	...
	propertyUpdateCmd.Flags().String("icon", "", "New property icon; pass an empty value to clear")
