...
func init() {
	...
	f.Duration("agent-timeout", 0, "Absolute per-task wall-clock cap; 0 = no cap, rely on idle watchdog (env: MULTICA_AGENT_TIMEOUT)")
	...
	rf.Duration("agent-timeout", 0, "Absolute per-task wall-clock cap; 0 = no cap, rely on idle watchdog (env: MULTICA_AGENT_TIMEOUT)")
