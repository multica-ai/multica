...
var rootHelpTemplate = `Work seamlessly with Wallts from the command line.

USAGE
  wallts <command> <subcommand> [flags]
{{range .Groups}}
{{.Title}}
...
EXAMPLES
  ...
  $ wallts daemon start
  $ wallts agent list --output json

ENVIRONMENT VARIABLES
  WALLTS_SERVER_URL    Override the default server URL
  WALLTS_WORKSPACE_ID  Set the active workspace

LEARN MORE
  Use ` + "`wallts <command> <subcommand> --help`" + ` for more information about a command.
`
