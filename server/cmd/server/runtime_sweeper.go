...
const (
	...
	// (MUL-3064). The historical default is 2.5h; deployments that run
	// research-style tasks can raise it via MULTICA_TASK_RUNNING_TIMEOUT.
	defaultRunningTimeoutSeconds = 9000.0
