		...
		r.Group(func(r chi.Router) {
			...
			r.Route("/api/projects", func(r chi.Router) {
				...
				r.Route("/{id}", func(r chi.Router) {
					...
					r.Get("/space/files", h.ListProjectSpaceFiles)
					r.Post("/space/imports", h.CreateProjectSpaceImport)
					r.Get("/space/imports", h.ListProjectSpaceImports)
					r.Get("/space/imports/{importId}", h.GetProjectSpaceImport)
					r.Put("/space/imports/{importId}/files/{fileId}", h.UploadProjectSpaceImportFile)
					r.Post("/space/imports/{importId}/complete", h.CompleteProjectSpaceImport)
					r.Post("/space/save-attachments", h.SaveAttachmentsToProjectSpace)
					r.Post("/space/organize", h.OrganizeProjectSpace)
				})
			})
