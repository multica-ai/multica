...
func NewRouterWithOptions(pool *pgxpool.Pool, hub *realtime.Hub, bus *events.Bus, analyticsClient analytics.Client, rdb redis.UniversalClient, opts RouterOptions) (chi.Router, *handler.Handler) {
	...
	r.Route("/api/daemon", func(r chi.Router) {
		...
		r.Post("/tasks/{taskId}/code-changes", h.ReportTaskCodeChanges)
		...
		r.Group(func(r chi.Router) {
			...
			r.Route("/api/issues", func(r chi.Router) {
				...
				r.Route("/{id}", func(r chi.Router) {
					...
					r.Get("/code-changes", h.ListIssueCodeChanges)
					r.Get("/code-changes/{changeId}", h.GetIssueCodeChange)
					...
					r.Get("/pull-requests/{prId}/diff", h.GetIssuePullRequestDiff)
