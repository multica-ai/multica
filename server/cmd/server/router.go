		...
		r.Group(func(r chi.Router) {
			...
			r.Route("/api/issues", func(r chi.Router) {
				...
				r.Route("/{id}", func(r chi.Router) {
					...
					r.Get("/description/versions", h.ListIssueDescriptionVersions)
					r.Get("/description/versions/{versionId}", h.GetIssueDescriptionVersion)
					r.Post("/description/versions/{versionId}/restore", h.RestoreIssueDescriptionVersion)
