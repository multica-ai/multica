...
func main() {
	...
	registerNotificationListeners(bus, queries, inboxv2.NewService(queries, pool))
	...
	go runAutopilotFailureMonitor(autopilotCtx, queries, inboxv2.NewService(queries, pool), bus, envFailureMonitorConfig())
