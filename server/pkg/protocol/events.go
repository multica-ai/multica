...
const (
	...
	EventDaemonCustomRuntimeAdd       = "daemon:custom_runtime_add"
	EventDaemonCustomRuntimeDelete    = "daemon:custom_runtime_delete"
	EventDaemonCustomRuntimeAddResult = "daemon:custom_runtime_add_result"
