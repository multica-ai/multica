...
type TaskMessagePayload struct {
	...
	ChannelID string         `json:"channel_id,omitempty"` // set for channel message tasks
	Seq       int            `json:"seq"`
...
// ChannelCreatedPayload is broadcast when a new channel is created.
type ChannelCreatedPayload struct {
	ChannelID string `json:"channel_id"`
}

// ChannelMessagePayload is broadcast when a message is sent to a channel.
