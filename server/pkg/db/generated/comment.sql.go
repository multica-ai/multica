...
WHERE id = $1
  AND workspace_id = $2
RETURNING id, issue_id, author_type, author_id, content, type, created_at, updated_at, parent_id, workspace_id, resolved_at, resolved_by_type, resolved_by_id, source_task_id, quick_action_id, via_plugin_id, revision, recovery_settled_at, deleted_at, request_key, request_payload_sha256, trigger_revision
`
...
SELECT id, issue_id, author_type, author_id, content, type, created_at, updated_at, parent_id, workspace_id, resolved_at, resolved_by_type, resolved_by_id, source_task_id, quick_action_id, via_plugin_id, revision, recovery_settled_at, deleted_at, request_key, request_payload_sha256, trigger_revision FROM comment
WHERE id = $1
`
...
const getCommentByCreateRequest = `-- name: GetCommentByCreateRequest :one
SELECT id, issue_id, author_type, author_id, content, type, created_at, updated_at, parent_id, workspace_id, resolved_at, resolved_by_type, resolved_by_id, source_task_id, quick_action_id, via_plugin_id, revision, recovery_settled_at, deleted_at, request_key, request_payload_sha256, trigger_revision
FROM comment
...
type GetCommentByCreateRequestParams struct {
	WorkspaceID pgtype.UUID `json:"workspace_id"`
	AuthorType  string      `json:"author_type"`
	AuthorID    pgtype.UUID `json:"author_id"`
	RequestKey  pgtype.Text `json:"request_key"`
...
func (q *Queries) GetCommentByCreateRequest(ctx context.Context, arg GetCommentByCreateRequestParams) (Comment, error) {
	row := q.db.QueryRow(ctx, getCommentByCreateRequest,
		arg.WorkspaceID,
		arg.AuthorType,
		arg.AuthorID,
		arg.RequestKey,
...
const getCommentInWorkspaceForTriggerDelivery = `-- name: GetCommentInWorkspaceForTriggerDelivery :one
SELECT id, issue_id, author_type, author_id, content, type, created_at, updated_at, parent_id, workspace_id, resolved_at, resolved_by_type, resolved_by_id, source_task_id, quick_action_id, via_plugin_id, revision, recovery_settled_at, deleted_at, request_key, request_payload_sha256, trigger_revision FROM comment
WHERE id = $1 AND workspace_id = $2
FOR UPDATE
`

type GetCommentInWorkspaceForTriggerDeliveryParams struct {
	ID          pgtype.UUID `json:"id"`
	WorkspaceID pgtype.UUID `json:"workspace_id"`
}
...
func (q *Queries) GetCommentInWorkspaceForTriggerDelivery(ctx context.Context, arg GetCommentInWorkspaceForTriggerDeliveryParams) (Comment, error) {
	row := q.db.QueryRow(ctx, getCommentInWorkspaceForTriggerDelivery, arg.ID, arg.WorkspaceID)
	var i Comment
	err := row.Scan(
		&i.ID,
		&i.IssueID,
...
WITH RECURSIVE ancestor_path AS (
  SELECT c.id, c.issue_id, c.author_type, c.author_id, c.content, c.type, c.created_at, c.updated_at, c.parent_id, c.workspace_id, c.resolved_at, c.resolved_by_type, c.resolved_by_id, c.source_task_id, c.quick_action_id, c.via_plugin_id, c.revision, c.recovery_settled_at, c.deleted_at, c.request_key, c.request_payload_sha256, c.trigger_revision, ARRAY[c.id]::uuid[] AS visited_ids, 1::integer AS depth, false AS cycle
  FROM comment c
  WHERE c.id = $1
  ...
  SELECT parent.id, parent.issue_id, parent.author_type, parent.author_id, parent.content, parent.type, parent.created_at, parent.updated_at, parent.parent_id, parent.workspace_id, parent.resolved_at, parent.resolved_by_type, parent.resolved_by_id, parent.source_task_id, parent.quick_action_id, parent.via_plugin_id, parent.revision, parent.recovery_settled_at, parent.deleted_at, parent.request_key, parent.request_payload_sha256, parent.trigger_revision,
...
SELECT id, issue_id, author_type, author_id, content, type, created_at, updated_at, parent_id, workspace_id, resolved_at, resolved_by_type, resolved_by_id, source_task_id, quick_action_id, via_plugin_id, revision, recovery_settled_at, deleted_at, request_key, request_payload_sha256, trigger_revision FROM (
    SELECT id, issue_id, author_type, author_id, content, type, created_at, updated_at, parent_id, workspace_id, resolved_at, resolved_by_type, resolved_by_id, source_task_id, quick_action_id, via_plugin_id, revision, recovery_settled_at, deleted_at, request_key, request_payload_sha256, trigger_revision FROM comment
    WHERE issue_id = $1 AND workspace_id = $2
