...
const updateTaskPromptMetrics = `-- name: UpdateTaskPromptMetrics :exec
...
type UpdateTaskPromptMetricsParams struct {
...
func (q *Queries) UpdateTaskPromptMetrics(ctx context.Context, arg UpdateTaskPromptMetricsParams) error {
	_, err := q.db.Exec(ctx, updateTaskPromptMetrics,
		arg.ID,
		arg.SystemPromptTokens,
		arg.ReferenceTokens,
		arg.InstructionsTokens,
		arg.CompactionDetected,
	)
	return err
}
