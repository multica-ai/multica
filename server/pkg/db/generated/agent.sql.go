...
type CreateAgentParams struct {
	...
	OperatingMode            pgtype.Text `json:"operating_mode"`
}
...
UPDATE agent SET
    ...
    operating_mode = COALESCE($7::text, operating_mode),
