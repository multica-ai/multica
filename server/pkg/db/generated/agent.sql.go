...
const getLastTaskWorkDirForIssueAndAgent = `-- name: GetLastTaskWorkDirForIssueAndAgent :one
...
type GetLastTaskWorkDirForIssueAndAgentParams struct {
	AgentID pgtype.UUID `json:"agent_id"`
	IssueID pgtype.UUID `json:"issue_id"`
}
...
func (q *Queries) GetLastTaskWorkDirForIssueAndAgent(ctx context.Context, arg GetLastTaskWorkDirForIssueAndAgentParams) (pgtype.Text, error) {
	row := q.db.QueryRow(ctx, getLastTaskWorkDirForIssueAndAgent, arg.AgentID, arg.IssueID)
