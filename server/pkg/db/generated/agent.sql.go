...
type CreateAgentParams struct {
	...
	A2aInvocationMode        interface{} `json:"a2a_invocation_mode"`
}
...
SELECT id, workspace_id, name, avatar_url, runtime_mode, runtime_config, visibility, status, max_concurrent_tasks, owner_id, created_at, updated_at, description, runtime_id, instructions, archived_at, archived_by, custom_env, custom_args, mcp_config, model, thinking_level, composio_toolkit_allowlist, permission_mode, kind, system_key, disabled_runtime_skills, service_tier, a2a_invocation_mode FROM agent
WHERE id = $1
`
...
UPDATE agent SET
    ...
    a2a_invocation_mode = COALESCE($10, a2a_invocation_mode),
...
type UpdateAgentParams struct {
	...
	A2aInvocationMode        pgtype.Text `json:"a2a_invocation_mode"`
