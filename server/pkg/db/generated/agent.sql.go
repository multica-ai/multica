...
UPDATE agent SET
    name = CASE WHEN global_agent_id IS NULL THEN COALESCE($2, name) ELSE name END,
    description = CASE WHEN global_agent_id IS NULL THEN COALESCE($3, description) ELSE description END,
    avatar_url = CASE WHEN global_agent_id IS NULL THEN COALESCE($4, avatar_url) ELSE avatar_url END,
    ...
    instructions = CASE WHEN global_agent_id IS NULL THEN COALESCE($12, instructions) ELSE instructions END,
    ...
    conversation_starters = CASE WHEN global_agent_id IS NULL THEN COALESCE($19, conversation_starters) ELSE conversation_starters END,
