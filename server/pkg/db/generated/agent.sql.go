...
RETURNING id, agent_id, issue_id, status, priority, dispatched_at, started_at, completed_at, result, error, created_at, context, runtime_id, session_id, work_dir, trigger_comment_id, chat_session_id, autopilot_run_id, attempt, max_attempts, parent_task_id, failure_reason, last_heartbeat_at, system_prompt_tokens, reference_tokens, instructions_tokens, compaction_detected
`
...
func (q *Queries) CancelAgentTask(ctx context.Context, id pgtype.UUID) (AgentTaskQueue, error) {
	...
	err := row.Scan(
		...
		&i.FailureReason,
		&i.LastHeartbeatAt,
		&i.SystemPromptTokens,
		&i.ReferenceTokens,
		&i.InstructionsTokens,
		&i.CompactionDetected,
	)
	return i, err
}
...
SELECT id, agent_id, issue_id, status, priority, dispatched_at, started_at, completed_at, result, error, created_at, context, runtime_id, session_id, work_dir, trigger_comment_id, chat_session_id, autopilot_run_id, attempt, max_attempts, parent_task_id, failure_reason, last_heartbeat_at, system_prompt_tokens, reference_tokens, instructions_tokens, compaction_detected FROM agent_task_queue
WHERE id = $1
`
...
SELECT atq.id, atq.agent_id, atq.issue_id, atq.status, atq.priority, atq.dispatched_at, atq.started_at, atq.completed_at, atq.result, atq.error, atq.created_at, atq.context, atq.runtime_id, atq.session_id, atq.work_dir, atq.trigger_comment_id, atq.chat_session_id, atq.autopilot_run_id, atq.attempt, atq.max_attempts, atq.parent_task_id, atq.failure_reason, atq.last_heartbeat_at, atq.system_prompt_tokens, atq.reference_tokens, atq.instructions_tokens, atq.compaction_detected FROM agent_task_queue atq
JOIN agent a ON a.id = atq.agent_id
WHERE a.workspace_id = $1
