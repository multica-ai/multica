...
const acknowledgeAgentTaskCancellation = `-- name: AcknowledgeAgentTaskCancellation :one
...
func (q *Queries) AcknowledgeAgentTaskCancellation(ctx context.Context, id pgtype.UUID) (AgentTaskQueue, error) {
	row := q.db.QueryRow(ctx, acknowledgeAgentTaskCancellation, id)
