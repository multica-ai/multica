...
const deleteWorkspaceAutomation = `-- name: DeleteWorkspaceAutomation :exec
...
func (q *Queries) DeleteWorkspaceAutomation(ctx context.Context, workspaceID pgtype.UUID) error {
	_, err := q.db.Exec(ctx, deleteWorkspaceAutomation, workspaceID)
	return err
}
