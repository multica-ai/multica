...
INSERT INTO agent_task_queue (
    ...
    concrete_model, requested_concrete_model,
    id
)
SELECT
    ...
    sqlc.narg(requested_concrete_model),
...
INSERT INTO agent_task_queue (
    ...
    trigger_evidence_kind, trigger_evidence_ref_id, fire_at, concrete_model, requested_concrete_model,
    id
)
SELECT
