...
GROUP BY DATE(tu.created_at AT TIME ZONE sqlc.arg('tz')::text), tu.provider, tu.model
ORDER BY DATE(tu.created_at AT TIME ZONE sqlc.arg('tz')::text) DESC, tu.provider, tu.model;
