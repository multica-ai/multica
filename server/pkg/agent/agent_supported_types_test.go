...
func TestSupportedTypesMatchesMigrationWhitelist(t *testing.T) {
	want := map[string]bool{
		...
		"opencode": true, "openclaw": true, "wujieclaw": true, "hermes": true,
		"gemini": true, "pi": true, "cursor": true, "kimi": true, "kiro": true,
		"DeepSeek-TUI": true, "antigravity": true, "qoderclicn": true, "mmx": true,
	}
