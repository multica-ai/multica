...
// Hermes, Pi, Cursor, Kimi, Kiro, Antigravity, Qoder, Trae, Grok). It mirrors the
...
// migration 134 to add qoder, migration 136 to add traecli, and migration 161
...
// so the family picker rejected it (#4945). grok is xAI's Grok Build CLI,
// driven over ACP via `grok agent --always-approve stdio` (#2895).
