...
var MinVersions = map[string]string{
	...
	"dim":     "0.3.10",  // cross-run session/load
	"mcode":   "0.1.2",   // ACP v1 session/new, prompt, MCP capability forwarding  // cross-run session/load: per-process lock releases on graceful exit
}
