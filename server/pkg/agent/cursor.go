...
func (u *cursorUsage) UnmarshalJSON(data []byte) error {
	var raw struct {
		...
		ReasoningOutputTokensCamel    int64 `json:"reasoningOutputTokens"`
	}
	...
	u.ReasoningOutputTokens = firstNonZeroInt64(raw.ReasoningOutputTokensSnake, raw.ReasoningOutputTokensCamel)
	return nil
}
