...
// thinking.go discovers per-model reasoning/effort catalogs for the claude,
// codex, opencode, and kimi backends so the daemon can advertise them to the UI
// without hard-coding (and getting wrong) what's installed locally.
//
