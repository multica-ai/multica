...
> ```
>
> This pulls the official Multica images from GHCR (latest stable by default). Requires Docker **or** Podman with Compose. See the [Self-Hosting Guide](SELF_HOSTING.md) for details.
