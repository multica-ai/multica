...
The daemon runs in the background and auto-detects agent CLIs (`claude`, `codex`, `copilot`, `openclaw`, `opencode`, `hermes`, `agy`, `pi`, `cursor-agent`, `kimi`, `kiro-cli`) on your PATH.
