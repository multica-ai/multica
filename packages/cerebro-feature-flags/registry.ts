...
export const CEREBRO_FLAG_DEFAULTS: Record<CerebroFlagKey, boolean> = {
  ...
  cerebro_permission_detail: true,
...
export const CEREBRO_FLAGS: CerebroFlagDefinition[] = [
  ...
  },
  {
    ...
    label: "Why Access and Permission audit",
    group: "permissions",
    description:
      "Explain why a person or agent has access to a capability and audit every effective decision across workspace, runtime, agent, group and member layers. Uses the same resolved policy answer as get_agent_capabilities. FIR-3403.",
  },
  {
  ...
  },
  {
    ...
    group: "workspace",
    description:
      "Plan strategy horizons and treat existing Projects as Rocks with transparent Issue rollups. Off hides the Strategy and Rocks routes and navigation. FIR-2816.",
  },
  {
