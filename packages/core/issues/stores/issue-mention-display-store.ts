 ...
 *
 * Like `issue-link-store`, this is a personal reading-ergonomics preference
 * (closer to theme than to workspace policy), so it persists globally via
 * `defaultStorage` rather than per-workspace storage.
 */
