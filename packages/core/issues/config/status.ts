...
> = {
  ...
  ready_for_dev: { label: "Ready for Dev", iconColor: "text-indigo-500", hoverBg: "hover:bg-indigo-500/10", dividerColor: "bg-indigo-500", badgeBg: "bg-indigo-500", badgeText: "text-white", columnBg: "bg-indigo-500/5" },
