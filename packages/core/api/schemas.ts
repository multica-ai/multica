...
export const AgentTaskSchema = z.object({
  ...
  agent_id: z.string().default(""),
  runtime_id: z.string().default(""),
  runtime_binding_mode: z.enum(["fixed", "pool"]).optional().default("fixed"),
  wait_reason: z.string().optional().default(""),
  session_affinity_state: z.enum(["none", "pinned", "removed"]).optional().default("none"),
