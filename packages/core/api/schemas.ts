...
const AutopilotListItemSchema = z.object({
  ...
  resource_failure_retry_enabled: z.boolean().optional(),
  resource_failure_retry_delay_seconds: z.number().int().optional(),
  failure_receipt_issue_id: z.string().nullable().optional(),
  failure_receipt_marker: z.string().nullable().optional(),
