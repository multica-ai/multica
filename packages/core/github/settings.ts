 ...
 * key of the status the issue moves to. Absent means Done. Not GitHub-specific
 * — self-hosted providers follow the same setting — so it ignores the GitHub
 * master switch. The server re-validates the key against the status catalog.
 */
