...
function workspaceScoped(slug: string) {
  ...
  return {
    ...
    workflowInbox: () => `${ws}/workflows/inbox`,
    workflowDetail: (id: string) => `${ws}/workflows/${encode(id)}`,
    knowledge: () => `${ws}/knowledge`,
    knowledgeBase: (id: string) => `${ws}/knowledge/${encode(id)}`,
    knowledgeGraph: (id: string) => `${ws}/knowledge/${encode(id)}/graph`,
    knowledgeAsk: (id: string) => `${ws}/knowledge/${encode(id)}/ask`,
    knowledgeDocument: (baseId: string, documentId: string) => `${ws}/knowledge/${encode(baseId)}/documents/${encode(documentId)}`,
    knowledgeBaseSettings: (id: string) => `${ws}/knowledge/${encode(id)}/settings`,
