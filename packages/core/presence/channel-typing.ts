...
// CEREBRO-PATCH(channel-typing-core): TECH-3664 — lifted from
// @multica/cerebro-inbox-slack-block into @multica/core/presence (next to the
// member-presence backbone) so packages/views can subscribe + notify without a
// dependency cycle (slack-block depends on views). The slack-block hook now
// re-exports this. Same rationale as member-presence-core (TECH-3583).
//
...
import { postTyping } from "./presence-api";
