// Client freeze watchdog for browser hosts.
//
...
// survives. Browser hosts have no external process watching the renderer, so
// this observer is their freeze signal.
//
...
// under the renderer-hang threshold, so an event here means "the user
