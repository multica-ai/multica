...
describe("useRealtimeSync — ws instance change", () => {
  ...
  it("invalidates exactly once when a new ws instance appears after null gap", () => {
    ...
    // (16 workspace-scoped [now incl. property definitions] + 6 per-issue
    // prefixes + 4 per-chat prefixes + 1 workspaceKeys.list() + 1
    // cross-workspace inbox unread summary = 28 calls)
