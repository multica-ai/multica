...
describe("useRealtimeSync — ws instance change", () => {
  ...
  it("invalidates exactly once when a new ws instance appears after null gap", () => {
    ...
    // (17 workspace-scoped [incl. property definitions and the issue-status
    // catalog] + 6 per-issue prefixes + 5 per-chat prefixes + 1
    // workspaceKeys.list() + 1 cross-workspace inbox unread summary = 30 calls)
