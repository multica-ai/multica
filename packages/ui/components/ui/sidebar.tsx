...
function Sidebar({
  ...
  return (
    <div
      className="group peer max-lg:hidden text-sidebar-foreground lg:block"
      data-state={state}
    ...
    >
      ...
      <div
        ...
        data-side={side}
        className={cn(
          "fixed inset-y-0 z-10 max-lg:hidden h-svh w-(--sidebar-width) transition-[left,right,width] duration-200 ease-out motion-reduce:transition-none lg:flex",
