 ...
 *
 * Uses exact hostname match against `cdnDomain` (e.g. "wallts-static.copilothub.ai"),
 ...
 * @param cdnDomain CDN hostname for legacy link detection (e.g. "wallts-static.copilothub.ai")
 */
