...
const STATUS_LABEL: Record<AgentContextChangeRequest["status"], string> = {
  pending: "Pending",
  approved: "Approved",
  rejected: "Rejected",
  merged: "Merged",
...
const STATUS_CLASS: Record<AgentContextChangeRequest["status"], string> = {
...
export function AgentContextChangeRequestQueue({
  agent,
  wsId,
  members,
  canReview,
  ...
  const [reviewTarget, setReviewTarget] =
    useState<AgentContextChangeRequest | null>(null);
