...
export function ContextAnchorButton() {
  ...
  const tooltipText = isDisabled
    ? "Nothing to share with Forge on this page"
    : focusMode && candidate
      ? candidate.type === "issue"
        ? `Forge knows you're viewing ${candidate.label} · Click to turn off`
        : `Forge knows you're viewing project "${candidate.label}" · Click to turn off`
      : "Let Forge know what you're viewing";
      ...
      <TooltipTrigger
        render={
          <Button
            ...
            disabled={isDisabled}
            aria-label={
              focusMode ? "Stop sharing current page" : "Share current page with Forge"
            }
...
export function ContextAnchorCard() {
  ...
  const tooltipText =
    candidate.type === "issue"
      ? `Forge knows you're viewing ${candidate.label}${candidate.subtitle ? ` — ${candidate.subtitle}` : ""}`
      : `Forge knows you're viewing project "${candidate.label}"`;
