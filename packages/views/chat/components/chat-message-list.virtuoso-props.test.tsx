...
//
// This suite lives in its own file because it module-mocks `react-virtuoso`;
// the live-timeline regression suite in `chat-message-list.test.tsx` renders
// the real Virtuoso and must not share that mock.
