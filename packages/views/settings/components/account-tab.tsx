...
export function AccountTab() {
  ...
  const handleProfileSave = async () => {
    ...
    try {
      ...
      toast.error(e instanceof Error ? e.message : t.profile.profileFailed);
    } finally {
  ...
  return (
    <div className="space-y-8">
      <section className="space-y-4">
        <h2 className="text-sm font-semibold">{t.profile.sectionTitle}</h2>
        ...
        <Card>
          <CardContent className="space-y-4">
            ...
            <div>
              <Label className="text-xs text-muted-foreground">{t.profile.nameLabel}</Label>
              <Input
                type="search"
                value={profileName}
            ...
            <div className="flex items-center justify-end gap-2 pt-1">
              ...
              >
                ...
                {profileSaving ? t.profile.savingButton : t.profile.saveButton}
              </Button>
            </div>
          </CardContent>
        </Card>
