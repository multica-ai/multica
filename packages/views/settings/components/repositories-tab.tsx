...
export function RepositoriesTab() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      toast.success(t.repositories.saveSuccess);
    } catch (e) {
      toast.error(e instanceof Error ? e.message : t.repositories.saveFailed);
    } finally {
      setSaving(false);
    }
  };
  ...
  return (
    <div className="space-y-8">
      <section className="space-y-4">
        <h2 className="text-sm font-semibold">{t.repositories.sectionTitle}</h2>
            ...
            {canManageWorkspace && (
              <div className="flex items-center justify-between pt-1">
                ...
                >
                  ...
                  {saving ? t.repositories.savingButton : t.repositories.saveButton}
                </Button>
              </div>
            )}
