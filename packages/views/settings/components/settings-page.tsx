...
export function SettingsPage({ extraAccountTabs }: SettingsPageProps = {}) {
  ...
  const accountTabs = [
    { value: "profile", label: t.page.tabProfile, icon: User },
    { value: "appearance", label: t.page.tabAppearance, icon: Palette },
    { value: "tokens", label: t.page.tabTokens, icon: Key },
  ];

  const workspaceTabs = [
    { value: "workspace", label: t.page.tabWorkspace, icon: Settings },
    { value: "repositories", label: t.page.tabRepositories, icon: FolderGit2 },
    { value: "labs", label: t.page.tabLabs, icon: FlaskConical },
    { value: "members", label: t.page.tabMembers, icon: Users },
  ];
      ...
      <div className="w-52 shrink-0 border-r overflow-y-auto p-4">
        ...
        <TabsList variant="line" className="flex-col items-stretch">
          ...
          <span className="px-2 pb-1 pt-4 text-xs font-medium text-muted-foreground truncate">
            {workspaceName ?? t.page.workspaceFallback}
          </span>
