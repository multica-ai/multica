...
describe("McpTab", () => {
  ...
  it("labels each transport icon without repeating the transport in the row", () => {
  ...
  it("keeps inline rename open when the server rejects the change", async () => {
    const user = userEvent.setup();
    mockUpdate.mockRejectedValueOnce(new Error("Rename failed"));
    render(<McpTab />, { wrapper: Wrapper });
