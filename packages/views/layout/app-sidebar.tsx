...
const personalNav: { key: NavKey; labelKey: string; icon: typeof Inbox }[] = [
  { key: "inbox", labelKey: "inbox", icon: Inbox },
  { key: "myIssues", labelKey: "my_issues", icon: CircleUser },
];

const workspaceNav: { key: NavKey; labelKey: string; icon: typeof Inbox }[] = [
  { key: "issues", labelKey: "issues", icon: ListTodo },
  { key: "projects", labelKey: "projects", icon: FolderKanban },
  { key: "autopilots", labelKey: "autopilot", icon: Zap },
  { key: "agents", labelKey: "agents", icon: Bot },
];

const configureNav: { key: NavKey; labelKey: string; icon: typeof Inbox }[] = [
                      ...
                      <DropdownMenuGroup>
                        ...
                        {myInvitations.map((inv) => (
                          <div key={inv.id} className="flex items-center gap-2 px-2 py-1.5">
                            ...
                            <span className="flex-1 truncate text-sm">{inv.workspace_name ?? t("workspace")}</span>
                            <button
                              type="button"
                      ...
                      >
                        ...
                        {item.key === "inbox" && unreadCount > 0 && (
                          <span className="ml-auto text-xs">
                            {unreadCount > 99 ? t("inbox_count_overflow") : unreadCount}
                          </span>
                        )}
                      </SidebarMenuButton>
                    </SidebarMenuItem>
