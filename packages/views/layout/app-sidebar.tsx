...
import { useCurrentWorkspace, useWorkspacePaths, paths, resolveRouteIconName } from "@multica/core/paths";
...
// Nav item icons are NOT declared here — they are resolved at render time from
// the shared route→icon map in `@multica/core/paths` (via `resolveRouteIconName`)
// so the sidebar and the desktop tab bar always agree. See route-icon-components.tsx.
            ...
            <SidebarGroupContent>
              <SidebarMenu className="gap-0.5">
                {personalNav.map((item) => {
                  ...
                  const Icon = ROUTE_ICON_COMPONENTS[resolveRouteIconName(href)];
