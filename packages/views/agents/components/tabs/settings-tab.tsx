...
export function SettingsTab({
  ...
  return (
    <div className="max-w-lg space-y-6">
      <div>
        <Label className="text-xs text-muted-foreground">{t.settings.avatarLabel}</Label>
      ...
      <div>
        <Label className="text-xs text-muted-foreground">{t.settings.descriptionLabel}</Label>
        <Input
          value={description}
      ...
      <div>
        <Label className="text-xs text-muted-foreground">{t.settings.visibilityLabel}</Label>
        <div className="mt-1.5 flex gap-2">
          ...
          >
            ...
            <div className="text-left">
              <div className="font-medium">{t.settings.workspaceTitle}</div>
              <div className="text-xs text-muted-foreground">{t.settings.workspaceHelp}</div>
            </div>
          </button>
          <button
            type="button"
          ...
          >
            ...
            <div className="text-left">
              <div className="font-medium">{t.settings.privateTitle}</div>
              <div className="text-xs text-muted-foreground">{t.settings.privateHelp}</div>
            </div>
          </button>
        </div>
      </div>
      ...
      <div>
        <Label className="text-xs text-muted-foreground">{t.settings.maxConcurrentTasksLabel}</Label>
        <Input
          type="number"
          min={1}
          max={50}
      ...
      <div>
        <div className="flex items-center justify-between">
          <Label className="text-xs text-muted-foreground">{t.settings.runtimeLabel}</Label>
          {hasOtherRuntimes && (
            ...
            <div className="min-w-0 flex-1">
              <div className="flex items-center gap-2">
                <span className="truncate font-medium">
                  {selectedRuntime?.name ?? t.settings.noRuntimeAvailable}
                </span>
                {selectedRuntime?.runtime_mode === "cloud" && (
                  <span className="shrink-0 rounded bg-info/10 px-1.5 py-0.5 text-xs font-medium text-info">
                    {t.settings.cloudBadge}
                  </span>
                )}
              </div>
