...
export function EnvTab({
  agent,
  // CEREBRO-PATCH(env-tab-redacted-readonly): policy/role-redacted env is read-only.
  readOnly = false,
  onDirtyChange,
  onSaved,
}: {
  agent: Agent;
  // CEREBRO-PATCH(env-tab-redacted-readonly): gate edits when env is redacted by policy/role.
  readOnly?: boolean;
