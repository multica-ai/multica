...
import type { Agent, MemberWithUser, Squad } from "@wallts/core/types";
...
vi.mock("@wallts/ui/components/ui/input", () => ({
  Input: (props: React.InputHTMLAttributes<HTMLInputElement>) => (
    <input {...props} />
  ),
}));

vi.mock("@wallts/ui/components/ui/label", () => ({
