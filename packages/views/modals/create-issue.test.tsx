...
describe("CreateIssueModal", () => {
  ...
  it("persists the duplicate allow preference from the duplicate toast", async () => {
    ...
    await user.click(screen.getByRole("checkbox", { name: "Always create duplicate titles" }));
    await user.click(screen.getByRole("button", { name: "Create anyway" }));
  ...
  it("leaves stored duplicate-title defaults to the create mutation layer", async () => {
    const user = userEvent.setup();
