...
export interface EditorExtensionsOptions {
  ...
  getAllowedActorMention?: () => import("./mention-suggestion").MentionActorTarget | null;
  ...
  return [
    ...
    BaseMentionExtension.configure({
      ...
      ...(options.disableMentions
        ...
        : options.queryClient
          ? { suggestion: createMentionSuggestion(options.queryClient, { mode: options.mentionMode, getContextItems: options.getMentionContextItems, getAllowedActorMention: options.getAllowedActorMention }) }
          : {}),
    }),
