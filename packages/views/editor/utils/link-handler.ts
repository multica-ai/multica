...
import { isGlobalPath } from "@wallts/core/paths";
...
/**
 * Open a link — internal paths dispatch wallts:navigate, external open new tab.
 *
...
export function openLink(href: string, currentSlug?: string | null): void {
  if (href.startsWith("/")) {
    ...
    window.dispatchEvent(
      new CustomEvent("wallts:navigate", { detail: { path } }),
    );
  } else {
