...
describe("ReadonlyContent issue mention Markdown", () => {
  it("renders an issue mention inside a task list as an issue mention card", () => {
    ...
    // Cerebro renders issue mentions through IssueChip (issue-chip testid), not
    // upstream's IssueMentionCard — see CEREBRO-PATCH(issue-mention-new-tab).
    expect(getByTestId("issue-chip").textContent).toBe("MUL-123");
  });
