...
function ThreadEntry({
  ...
  // CEREBRO-PATCH(dm-channel-message-fixes): TECH-3316 — thread message
  // reminders follow the channel/DM message menu, independent of the older
  // issue-comment feature flag.
