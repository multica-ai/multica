...
// Prime Agent (prime) — official butterfly mark from
// PrimeIntellect-ai/prime-agent (assets/brand/prime-butterfly.svg, MIT —
// Copyright 2026 Prime Intellect). Upstream ships a #0b0f14 light-theme mark
// and a #ffffff dark-theme one whose paths are otherwise identical, so
// currentColor reproduces both from a single copy.
function PrimeLogo({ className }: { className: string }) {
  return (
    <svg viewBox="0 0 178 178" fill="currentColor" className={className}>
...
export function ProviderLogo({
  ...
  switch (provider) {
    ...
    case "prime":
      return <PrimeLogo className={className} />;
    default:
