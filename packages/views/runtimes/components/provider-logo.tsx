...
function NanobotLogo({ className }: { className: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className}>
      <path
        fillRule="evenodd"
        d="M5 1L2 10C1.5 17 6 22 12 22C18 22 22.5 17 22 10L19 1L14.5 7C13.8 6.2 12.8 5.8 12 5.8C11.2 5.8 10.2 6.2 9.5 7L5 1Z
           M8.5 11.2C9.3 11.2 9.8 12 9.8 13.2C9.8 14.4 9.3 15.2 8.5 15.2C7.7 15.2 7.2 14.4 7.2 13.2C7.2 12 7.7 11.2 8.5 11.2Z
           M15.5 11.2C16.3 11.2 16.8 12 16.8 13.2C16.8 14.4 16.3 15.2 15.5 15.2C14.7 15.2 14.2 14.4 14.2 13.2C14.2 12 14.7 11.2 15.5 11.2Z
           M12 15.5L13 16.5H11L12 15.5Z"
        fill="currentColor"
      />
    </svg>
  );
