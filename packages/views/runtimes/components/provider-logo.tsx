...
// DevEco Code — neutral "DE" lettermark placeholder. We intentionally do NOT
// embed the Huawei DevEco brand icon here: being able to extract it from a
// locally installed DevEco Studio bundle does not grant the right to
// redistribute the mark in an open-source repository. Swap this for an official
// DevEco Code asset once Huawei publishes one under a compatible license.
