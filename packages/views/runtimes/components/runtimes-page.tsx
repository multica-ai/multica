...
export function RuntimesPage({
  ...
  const scopedVisibleRuntimes = useMemo(() => {
    return filterRuntimesByScope(visibleRuntimes, scope, currentUserId);
  }, [visibleRuntimes, scope, currentUserId]);

  const machines = useMemo(
    () =>
      buildRuntimeMachines(scopedVisibleRuntimes, {
        now,
        localDaemonId,
        localMachineName,
        currentUserId,
