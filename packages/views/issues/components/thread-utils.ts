 ...
 * traversal order. Shared by the main timeline's thread-context affordances and
 * ResolvedThreadBar so counts stay in sync — direct-children-only counts diverge
