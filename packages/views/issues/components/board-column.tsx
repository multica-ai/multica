...
export function BoardColumn({
  ...
  totalCount?: number;
  footer?: ReactNode;
  /** CEREBRO-PATCH(board-column-cerebro): Extra data merged into the create-issue modal (e.g. project_id, privacy). */
            ...
            <TooltipTrigger
              render={
                <Button
                  ...
                  onClick={() => useModalStore.getState().open("create-issue", { status, ...createIssueData })}
                >
