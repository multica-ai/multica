...
export function BatchActionToolbar() {
  ...
  return (
    <>
      <div className="fixed bottom-4 sm:bottom-6 left-1/2 -translate-x-1/2 z-50 flex max-w-[calc(100vw-1rem)] items-center gap-1 overflow-x-auto rounded-lg border bg-background px-2 py-1.5 shadow-lg">
