...
import { BellRing, Hash, MessagesSquare } from "lucide-react"; // CEREBRO-PATCH(inbox-reminder-snooze-signal): BellRing for the reminder badge
import { CerebroInboxRowActions, CerebroSwipeArchive, CerebroUnarchiveAction, CerebroInboxTimestamp, isReminderOverdue } from "@multica/cerebro-inbox"; // CEREBRO-PATCH(inbox-row-actions-mount) / CEREBRO-PATCH(inbox-unarchive-mount) / CEREBRO-PATCH(inbox-muted-timestamp) / CEREBRO-PATCH(inbox-reminder-snooze-signal)
...
export function InboxListItem({
  ...
  const { t } = useT("inbox"); // CEREBRO-PATCH(inbox-reminder-snooze-signal): reminder badge label
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        ...
        >
          ...
          {/* CEREBRO-PATCH(inbox-reminder-snooze-signal): red reminder badge so overdue/active reminders stand out while scanning the list. */}
          {reminderSignal && (
