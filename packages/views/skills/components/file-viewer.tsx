        ...
        <div className="flex items-center gap-1">
          {isMd && (
            <Tooltip>
              ...
              />
              <TooltipContent>
                {editing ? t.fileViewer.preview : t.fileViewer.edit}
              </TooltipContent>
            </Tooltip>
          )}
        </div>
      ...
      <div className="flex-1 min-h-0 overflow-y-auto">
        {isMd && !editing ? (
          ...
          <Textarea
            ...
            placeholder={
              isMd
                ? t.fileViewer.writeMarkdown
                : t.fileViewer.fileContent
            }
