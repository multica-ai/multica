...
export function MyIssuesHeader({ allIssues }: { allIssues: Issue[] }) {
  const t = useMyIssuesT();
  const scopes: { value: MyIssuesScope; label: string; description: string }[] = [
    { value: "assigned", ...t.scopes.assigned },
    { value: "created", ...t.scopes.created },
    { value: "agents", ...t.scopes.agents },
  ];
  ...
  const sortLabel =
    SORT_OPTIONS.find((o) => o.value === sortBy)?.label ?? t.toolbar.sortFallback;
      ...
      <div className="flex items-center gap-1">
        ...
        <DropdownMenu>
          <Tooltip>
            ...
            />
            <TooltipContent side="bottom">{t.toolbar.filter}</TooltipContent>
          </Tooltip>
          <DropdownMenuContent align="end" className="w-auto">
            ...
            <DropdownMenuSub>
              <DropdownMenuSubTrigger>
                ...
                <span className="flex-1">{t.toolbar.statusLabel}</span>
            ...
            <DropdownMenuSub>
              <DropdownMenuSubTrigger>
                ...
                <span className="flex-1">{t.toolbar.priorityLabel}</span>
        ...
        <Popover>
          <Tooltip>
            ...
            />
            <TooltipContent side="bottom">{t.toolbar.displaySettings}</TooltipContent>
          </Tooltip>
            ...
            <div className="border-b px-3 py-2.5">
              ...
              <div className="mt-2 flex items-center gap-1.5">
                ...
                <Button
                  ...
                  title={sortDirection === "asc" ? t.toolbar.sortAscending : t.toolbar.sortDescending}
                >
                  {sortDirection === "asc" ? (
        ...
        <DropdownMenu>
          <Tooltip>
            ...
            <TooltipContent side="bottom">
              {viewMode === "board" ? t.toolbar.boardView : t.toolbar.listView}
            </TooltipContent>
          </Tooltip>
          <DropdownMenuContent align="end" className="w-auto">
            <DropdownMenuGroup>
