      ...
      <Card className="w-full">
        <CardContent className="space-y-4">
          ...
          {state.kind === "idle" || state.kind === "redeeming" ? (
            <p className="text-sm text-muted-foreground">{t(($) => $.wecom_bind.redeeming)}</p>
            ...
            <>
              <p className="text-sm font-medium">{t(($) => $.wecom_bind.done_title)}</p>
            ...
            <>
              <p className="text-sm font-medium">{t(($) => $.wecom_bind.error_title)}</p>
              <p className="text-xs text-muted-foreground">
                {(() => {
                  switch (state.reason) {
                    case "missing_token":
