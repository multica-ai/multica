...
// WecomBindPage is the destination the bot's DM binding link points at.
// Auth is required before redeeming — the session user is bound, not the
// token alone (see wecom.BindingTokenService.RedeemAndBind).
