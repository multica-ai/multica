...
import { githubConfigFromStore } from "@multica/core/github/config";
...
export type HelperInstructionsLang = keyof typeof builders;
...
export const HELPER_INSTRUCTIONS = {
  en: buildHelperInstructions("en"),
  zh: buildHelperInstructions("zh"),
  ko: buildHelperInstructions("ko"),
  ja: buildHelperInstructions("ja"),
} as const;
