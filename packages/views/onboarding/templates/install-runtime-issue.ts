...
4. Terminalinizin Codex'i bulabildiğini doğrulayın:
   which codex
   codex --version
5. Multica'nın algılamasını bekleyin. Çalışan daemon, yeni kurulan CLI'ları birkaç dakikada bir yeniden kontrol eder; bu nedenle normalde yeniden başlatma gerekmez.
   Hemen uygulamak için:
   multica daemon restart
   Desktop uygulamasında herhangi bir yerel çalışma ortamını açıp Restart'a tıklayın. Uygulamayı kapatıp yeniden açmak yeterli değildir; daemon arka planda çalışmaya devam eder.
