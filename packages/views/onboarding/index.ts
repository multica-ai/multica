...
export { StarterContentPrompt } from "./components/starter-content-prompt"; // CEREBRO-PATCH(onboarding-index): preserve dashboard starter-content export after upstream sync
