  ...
  const tier1: ImportStarterIssuePayload[] = [
    {
      ...
      description: [
        ...
        `1. Go to [github.com/TheophilusChinomona/multica/releases/latest](https://github.com/TheophilusChinomona/multica/releases/latest) and download the \`.dmg\` for macOS`,
