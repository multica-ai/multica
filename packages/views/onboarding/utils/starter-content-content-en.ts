...
export function buildWelcomeIssueText(
  ...
  const header = [
    ...
    ``,
    `[Learn how Multica works →](/docs/how-multica-works)`,
    ``,
    `---`,
    ``,
  ].join("\n");
...
export function buildAgentGuidedSubIssues(
  ...
  const tier1: ImportStarterIssuePayload[] = [
    {
      ...
      description: [
        ...
        ``,
        `[Learn about assigning issues →](/docs/assigning-issues)`,
      ].join("\n"),
    },
    {
      status: "todo",
    ...
    },
    {
      ...
      description: [
        ...
        ``,
        `[Learn about workspaces →](/docs/workspaces)`,
      ].join("\n"),
    },
  ];
  ...
  if (q.use_case === "manage_team") {
    tier2.push({
      ...
      description: [
        ...
        ``,
        `[Learn about members and roles →](/docs/members-roles)`,
      ].join("\n"),
    });
  }
  ...
  tier2.push({
    ...
    description: [
      ...
      ``,
      `[Learn about creating agents →](/docs/agents-create)`,
    ].join("\n"),
  });
  ...
  const tier3: ImportStarterIssuePayload[] = [
    ...
    },
    {
      ...
      description: [
        ...
        ``,
        `[Learn about the inbox →](/docs/inbox)`,
      ].join("\n"),
    },
    {
      status: "backlog",
      ...
      description: [
        ...
        ``,
        `[Learn about autopilots →](/docs/autopilots)`,
      ].join("\n"),
    },
  ];
  ...
  const tier1: ImportStarterIssuePayload[] = [
    {
      ...
      description: [
        ...
        `1. Go to [github.com/furtherref/multica/releases/latest](https://github.com/furtherref/multica/releases/latest) and download the \`.dmg\` for macOS`,
        ...
        ``,
        `[Learn about runtimes →](/docs/daemon-runtimes)`,
      ].join("\n"),
    },
    {
      status: "todo",
