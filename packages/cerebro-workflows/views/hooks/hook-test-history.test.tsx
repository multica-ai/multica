...
describe("HookTestHistory", () => {
  it("explains the policy, scope, conditions, failure mode, and remediation", () => {
    ...
    expect(screen.getByText("Policy policy-1 · version 3")).toBeInTheDocument();
    expect(screen.getByText("Source scope: issue FIR-3321")).toBeInTheDocument();
