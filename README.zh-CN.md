...
- **可复用技能** — 每个解决方案都成为全团队可复用的技能。部署、数据库迁移、代码审查——技能让团队能力随时间持续增长。可以从官方 [Multica CLI skill](https://github.com/multica-ai/multica-cli) 开始，让本地 agent 通过已认证的 CLI 操作 Multica。
