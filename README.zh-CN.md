...
- **Windows 桌面应用** — Multica Win 为 Windows 用户提供原生、高性能的图形界面，轻松管理守护进程与 Agent。
...
### Windows
从我们的 [Releases](https://github.com/JIANQIANG-YU/Multica-Win/releases) 页面下载最新的 **Multica-Win.exe**。
- 原生 GUI 控制面板。
- 完美适配 DPI 缩放的现代界面。
- 一键直达工作区文件夹。
