#!/usr/bin/env node
// Builds the `wallts` CLI from server/cmd/wallts and copies the binary
...
//
// ldflags mirror `make build` so `wallts --version` reports a meaningful
// version / commit / date.
//
...
function binaryNameForPlatform(platform) {
  return platform === "win32" ? "wallts.exe" : "wallts";
}
