...
import { ProjectsPage } from "@wallts/views/projects/components";
import { DashboardPage } from "@wallts/views/dashboard";
import { AutopilotsPage } from "@wallts/views/autopilots/components";
import { MyIssuesPage } from "@wallts/views/my-issues";
import { SkillsPage } from "@wallts/views/skills";
import { DesktopRuntimesPage } from "./components/desktop-runtimes-page";
import { DesktopAgentsPage } from "./components/desktop-agents-page";
import { SquadsPage, SquadDetailPage as SquadDetailPageView } from "@wallts/views/squads/components";
import { InboxPage } from "@wallts/views/inbox";
import { SettingsPage } from "@wallts/views/settings";
