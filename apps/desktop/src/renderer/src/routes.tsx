...
import { OrgChartPage, RocksPage, StrategyPage, useCerebroOperatingSystemSettingsTabs } from "@multica/cerebro-operating-system/views";
    ...
    children: [
      { index: true, element: null },
      {
        ...
        children: [
          ...
          { path: "meetings", element: <CyclesPage />, handle: { title: "Cycles" } },
          { path: "org-chart", element: <OrgChartPage />, handle: { title: "Roles" } },
          {
            path: "approvals",
