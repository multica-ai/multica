...
import { NewWorkspacePage } from "@wallts/views/workspace/new-workspace-page";
import { InvitePage } from "@wallts/views/invite";
import { InvitationsPage } from "@wallts/views/invitations";
import { OnboardingFlow } from "@wallts/views/onboarding";
