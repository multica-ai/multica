...
export function ChatTitleButton({
  ...
  const agentName = currentAgent?.name ?? translate("Chat");
  const subtitle = currentSession?.title || translate("New chat");
  ...
  return (
    <Pressable
      ...
      accessibilityLabel={translate("Sessions and agent picker")}
    >
      <ActorAvatar
