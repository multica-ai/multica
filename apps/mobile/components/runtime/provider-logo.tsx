...
function CodexLogo({ size, color }: { size: number; color: string }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 16 16" fill="currentColor" color={color}>
...
function CopilotLogo({ size, color }: { size: number; color: string }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" color={color}>
      <Path
...
function QoderLogo({ size, color }: { size: number; color: string }) {
  return (
...
export function ProviderLogo({
  ...
  switch (provider) {
    ...
    case "codex":
      return <CodexLogo size={size} color={color ?? "#000000"} />;
    case "opencode":
    ...
    case "copilot":
      return <CopilotLogo size={size} color={color ?? "#000000"} />;
    case "cursor":
    ...
    case "qoder":
      return <QoderLogo size={size} color={color ?? "#000000"} />;
    case "antigravity":
