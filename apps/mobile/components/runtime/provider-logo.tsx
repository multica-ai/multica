/**
 * Mobile ProviderLogo — react-native-svg / expo-image mirror of
 * packages/views/runtimes/components/provider-logo.tsx. The vector marks
 * are translated 1:1 (same path/shape data) from DOM <svg> to
 * react-native-svg primitives; the three raster marks (Hermes, Trae,
 * Antigravity) render through expo-image's <Image> instead of a DOM <img>.
 * Mirrored, not imported — that file lives in packages/views, out of
 * mobile's @multica/core-only whitelist.
 */
...
const antigravityLogo = require("../../assets/runtime-logos/antigravity-logo.png");
...
function CodeBuddyLogo({ size }: { size: number }) {
...
function PiLogo({ size }: { size: number }) {
  return (
...
function CopilotLogo({ size }: { size: number }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" color="#000000">
      <Path
        fill="#000"
...
function CursorLogo({ size }: { size: number }) {
  return (
    <Svg width={size} height={size} viewBox="600 300 400 400" fill="none">
...
function KimiLogo({ size }: { size: number }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
function QoderLogo({ size }: { size: number }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path
...
function AntigravityLogo({ size }: { size: number }) {
  return (
    <Image
      source={antigravityLogo}
...
function KiroLogo({ size }: { size: number }) {
...
function TraeLogo({ size }: { size: number }) {
  return (
    <Image
      source={{ uri: TRAE_ICON }}
      style={{ width: size, height: size }}
      contentFit="contain"
    />
  );
...
export function ProviderLogo({
  ...
  provider: string;
  size?: number;
  /** Fallback icon tint when no brand mark is known for `provider`. */
  color?: string;
}) {
  switch (provider) {
    case "claude":
    ...
    case "codebuddy":
      return <CodeBuddyLogo size={size} />;
    case "codex":
    ...
    case "hermes":
      return <HermesLogo size={size} />;
    case "pi":
      return <PiLogo size={size} />;
    case "copilot":
      return <CopilotLogo size={size} />;
    case "cursor":
      return <CursorLogo size={size} />;
    case "kimi":
      return <KimiLogo size={size} />;
    case "kiro":
      return <KiroLogo size={size} />;
    case "qoder":
      return <QoderLogo size={size} />;
    case "antigravity":
