 ...
 * (MUL-6243).
 *
 * List sections are categories, so two issues sitting in the same "Started"
 ...
 * section header already names the lifecycle phase and repeating a built-in
 * status is pure noise. So a
