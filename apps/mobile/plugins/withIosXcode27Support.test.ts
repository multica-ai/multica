...
`;
  ...
  describe("cold-start deep links", () => {
    ...
    it("rebuilds launch options from connectionOptions instead of passing nil", () => {
      ...
      expect(contents).toContain("Generated by withIosXcode27Support v2");
    });
    ...
    it("forwards cold-start URLs and user activities to the subscribers and RCTLinkingManager", () => {
