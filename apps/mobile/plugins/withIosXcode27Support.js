 ...
 *    (URLs, user activities, quick actions, life cycle) to the Expo
 *    subscribers and React Native's linking manager exactly once. Delete the
 *    scene half of this plugin once the app moves to that SDK.
 *
...
const SCENE_DELEGATE_VERSION_MARKER = "Generated by withIosXcode27Support v2";
...
/// Generated by withIosXcode27Support v2.
class ${SCENE_DELEGATE_CLASS}: UIResponder, UIWindowSceneDelegate {
  ...
  func scene(_ scene: UIScene, willContinueUserActivityWithType userActivityType: String) -> Bool {
    ExpoAppDelegateSubscriberManager.application(
      UIApplication.shared,
  ...
  /// Routes a URL to the Expo subscribers, then to React Native's linking
  /// manager unless a subscriber already handled it — both feed expo-router's
  /// incoming-link handling, and a double call would deliver two JS \`url\`
  /// events for one link.
  ...
  /// Routes a universal link (or other user activity) to the Expo subscribers
  /// and React Native's linking manager. \`RCTLinkingManager\` only announces
