 ...
 *
 * On complete: land on the workspace issues list, or root if the flow never
 * produced a workspace. Starter content is offered after landing.
 *
...
export default function OnboardingPage() {
  ...
  return (
    <div className="h-full overflow-y-auto bg-background">
      <OnboardingFlow
        onComplete={(ws) => {
          // Runtime-connected onboarding no longer creates a welcome issue.
          // Skip/runtime-less exits all land on the workspace issues list.
