...
<Callout type="info">
This command requires the [GitHub CLI](https://cli.github.com/) (`gh`) with access to the firtal-group organization. Run `gh auth login` first if you haven't authenticated.
</Callout>
