...
const SAMPLE_LATEST_ASSET = {
  name: "wallts-desktop-0.2.14-mac-arm64.dmg",
  browser_download_url:
    "https://github.com/dwickyfp/wallts/releases/download/v0.2.14/wallts-desktop-0.2.14-mac-arm64.dmg",
};

const SAMPLE_PREV_ASSET = {
  name: "wallts-desktop-0.2.13-mac-arm64.dmg",
  browser_download_url:
    "https://github.com/dwickyfp/wallts/releases/download/v0.2.13/wallts-desktop-0.2.13-mac-arm64.dmg",
};
...
function releasePayload(overrides: {
  ...
  return {
    ...
    html_url: `https://github.com/dwickyfp/wallts/releases/tag/${overrides.tag}`,
