...
/**
 * Server-side fetcher for the latest Wallts release, designed to
...
const GITHUB_RELEASES_URL =
  "https://api.github.com/repos/dwickyfp/wallts/releases?per_page=2";
...
export async function fetchLatestRelease(): Promise<LatestRelease> {
  ...
  try {
    ...
    // Defensive filter — Wallts doesn't publish prereleases or drafts
