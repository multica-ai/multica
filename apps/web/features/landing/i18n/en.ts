    ...
    runtimes: {
      ...
      cards: [
        ...
        },
        {
          ...
          description:
            "Multica scans for 13 supported coding tools \u2014 Antigravity, Claude Code, Codex, Cursor, Copilot, ForgeCode, Gemini, Hermes, Kimi, Kiro CLI, OpenCode, OpenClaw, and Pi \u2014 and registers a runtime for each one it finds.",
        },
      ],
    },
  },
  ...
  howItWorks: {
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          "Run multica setup \u2014 it walks you through OAuth, starts the daemon, and scans for the 13 supported coding tools (Antigravity, Claude Code, Codex, Cursor, Copilot, ForgeCode, Gemini, Hermes, Kimi, Kiro CLI, OpenCode, OpenClaw, Pi). Whichever ones you already have installed get registered as runtimes automatically.",
      },
      {
