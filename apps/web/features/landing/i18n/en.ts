    ...
    runtimes: {
      ...
      cards: [
        ...
        },
        {
          ...
          description:
            "Multica scans for 12 supported coding tools \u2014 Claude Code, Codex, Cursor, Copilot, Gemini, Hermes, Kimi, Kiro CLI, OpenCode, OpenClaw, Pi, and Trae CLI \u2014 and registers a runtime for each one it finds.",
        },
      ],
    },
  },
  ...
  howItWorks: {
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          "Run multica setup \u2014 it walks you through OAuth, starts the daemon, and scans for the 12 supported coding tools (Claude Code, Codex, Cursor, Copilot, Gemini, Hermes, Kimi, Kiro CLI, OpenCode, OpenClaw, Pi, Trae CLI). Whichever ones you already have installed get registered as runtimes automatically.",
      },
      {
