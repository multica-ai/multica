    ...
    entries: [
      {
        version: "0.4.16",
        date: "2026-07-31",
        title: "Quicker actions, clearer links, and more capable agents",
        changes: [],
        features: [
          "Chat replies now offer one-click next steps.",
          "Create reusable Issue actions to start the right agent in one click.",
          "Plain Multica Issue and project links now appear as clickable chips.",
          "Mark notifications unread when you want to revisit them.",
          "Choose an emoji avatar and see the runtime behind each agent.",
          "Use Qoder CN as a Multica runtime.",
        ],
        improvements: [
          "Large self-hosted workspaces now delete much faster.",
          "Resource labels are now always available for agents and Skills.",
          "Linux Codex tasks now use the daemon account's familiar environment.",
          "Built-in Skills now use clearer, consistent names.",
          "Text across Multica is now clearer and more consistent.",
        ],
        fixes: [
          "Copilot prompts with newlines now work correctly on Windows.",
          "Long agent replies no longer lose their final updates.",
          "Timeline updates now keep the newest activity visible.",
          "Subscribers are now notified when agents create sub-Issues.",
          "Self-hosted deployments now use the correct backend port.",
          "Usage leaderboards now match their reported totals.",
          "Filtered Issue views now count only agents working there.",
          "WebSocket connections now reject oversized messages.",
          "Self-hosted upgrades no longer stop on duplicate migrations.",
          "Onboarding now has a clear way to sign out and start over.",
        ],
      },
      {
        version: "0.4.15",
