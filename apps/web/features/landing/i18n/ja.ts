      ...
      entries: [
        {
          version: "0.5.0",
          date: "2026-09-08",
          title: "コメント スレッド内のエージェント実行表示、スレッドごとのキュー、より安定したセッション、検索のタイムアウト減少",
          changes: [],
          features: [
            "エージェントの待機、実行の手順、停止と再試行、ログが、始めたコメント スレッドの中に表示されます。",
            "ルートのコメント スレッドごとにタスクが動くので、別の議論が混ざったり返信が消えたりしません。",
            "コメント スレッドの一覧が右側に移り、長い題名も読めます。",
          ],
          improvements: [
            "クイック作成から始めたタスクは Issue のアクティビティを埋めず、実行履歴から追えます。",
            "複雑な検索が途中で失敗せず、コメントの検索も速くなりました。",
          ],
          fixes: [
            "DingTalk で引用返信しながら /new や /clear を送っても、引用と指示が混ざりません。",
            "Lark の DM に連携カードが届かないとき、グループに理由が表示されます。",
            "Telegram で同じ返信が二重に届かなくなりました。",
            "途中で止めた Codex の実行でも、使ったトークンが記録されます。",
            "qoder、kiro、grok、kimi などで止まった会話が、次のメッセージで再開します。",
            "Lark から作った Issue のリンクが、正しいワークスペースで開きます。",
            "Cursor のタスクがサービスを起動したままでも、早く終わったように見えたり止まったりしません。",
            "Issue の分割表示でサイドバーの切り替えが二つ出なくなり、AI Team の表記も直りました。",
          ],
        },
        {
          version: "0.4.41",
