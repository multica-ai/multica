      ...
      entries: [
        {
          version: "0.3.24",
          date: "2026-06-17",
          title: "カスタムランタイムプロファイルと分かりやすいエージェント設定",
          changes: [],
          features: [
            "チームはカスタムランタイムプロファイルを作成し、エージェントが環境に合ったローカルツール、モデル選択、作業設定を使えるようになりました。",
            "コマンドラインでエージェントを作成または更新するときに思考レベルを選べるようになり、作業に合わせて推論の深さを調整しやすくなりました。",
          ],
          improvements: [
            "新規または更新されたランタイムプロファイルがアプリにより早く表示され、エージェントは現在の環境に最も合うプロファイルを優先します。",
            "クライアントのエラーやフリーズ報告は重複がまとまるため、ノイズが減り、確認しやすくなりました。",
            "Issue コメントのトリガープレビュー文言が分かりやすくなり、投稿後にどのエージェントやスクワッドが動き始めるかを確認しやすくなりました。",
          ],
          fixes: [
            "Office 365 メールは、最初のサインイン方法が使えない場合でもより安定して送信されます。",
            "GitHub 連携はインストール情報をより確実に保持し、CI がまだ実行中のときは待機中のチェックとして表示します。",
            "Codex の実行に必要なサービスが終了したときはすばやく失敗し、分かりにくい待機状態を避けます。",
            "ランタイム所有者は自己修復ランタイムを再び削除でき、ランタイム切り替え時には合わないモデル選択が自動で整理されます。",
            "Issue 画面は不明なアイコンを安全に扱い、コメント内の通常のファイル名が誤って外部リンクにならなくなりました。",
          ],
        },
        {
          version: "0.3.23",
