      ...
      entries: [
        {
          version: "0.4.16",
          date: "2026-07-31",
          title: "もっと素早い操作、見やすいリンク、より使えるエージェント",
          changes: [],
          features: [
            "チャットの返信に、ワンクリックで次へ進める候補が表示されます。",
            "Issue でエージェントと指示を保存し、ワンクリックで実行できます。",
            "Multica の Issue やプロジェクトURLが、クリックできるチップで表示されます。",
            "通知を未読に戻して、あとで確認できます。",
            "エージェントに絵文字のアバターを選び、利用中のランタイムも確認できます。",
            "Qoder CN を Multica のランタイムとして使えます。",
          ],
          improvements: [
            "大規模なセルフホストのワークスペースを、より速く削除できます。",
            "エージェントとスキルのリソースラベルを常に利用できます。",
            "Linux の Codex タスクがデーモンの環境を使えるようになりました。",
            "組み込みスキルの名前が、より分かりやすく統一されました。",
            "Multica 全体の文字が、より見やすく一貫しました。",
          ],
          fixes: [
            "Windows で Copilot の複数行プロンプトが正しく動作します。",
            "長いエージェント返信の最後の更新が失われなくなりました。",
            "タイムラインで最新のアクティビティを確認できます。",
            "エージェントが子 Issue を作成すると、購読者に通知されます。",
            "セルフホスト環境で正しいバックエンドポートが使われます。",
            "使用量ランキングが集計値と一致するようになりました。",
            "絞り込んだ Issue では、実際に作業中のエージェントだけを数えます。",
            "WebSocket 接続が大きすぎるメッセージを拒否します。",
            "セルフホストのアップグレードが重複マイグレーションで止まりません。",
            "オンボーディングを終了して、最初からやり直せます。",
          ],
        },
        {
          version: "0.4.15",
