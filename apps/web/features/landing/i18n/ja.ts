      ...
      entries: [
        {
          ...
          features: [
            ...
            "ツール出力が先頭だけ残っている場合、実行の詳細にその旨が表示されます。",
          ],
          improvements: [
          ...
          fixes: [
            "Lark の通常グループで、エージェントの返信があなたの質問を引用し、あなたをメンションします。",
            "複数の人が同時に質問しても、別の人をメンションしなくなりました。",
            "Analytics とコマンドラインが、未報告の使用量と本当にゼロの費用を区別します。",
            "使用量のデータが揃っていないときは、下限であることが示されます。",
            "Codex の環境を用意できないときも、新しい環境でタスクが始まります。",
            "Issue のエージェント実行カードが、実際に表示された時刻の順に並びます。",
            "選択肢の多いダイアログをスクロールでき、下の保存ボタンにも届きます。",
            "マージ済みの PR の本文に Closes を足すと、その Issue に表示されます。",
            "Issue に軽く触れただけの PR は、見えない関連付けを作りません。",
            "Issue の PR 一覧が空のとき、どこに書けば関連付くのかを案内します。",
          ],
        },
        {
          version: "0.4.42",
