      ...
      items: [
        {
          ...
          answer:
            "Multica는 Antigravity, Claude Code, CodeBuddy, Codex, Copilot, Cursor, DeepSeek Harness, DevEco Code, Grok, Hermes, Kimi, Kiro CLI, Oh-My-Pi, OpenClaw, OpenCode, Pi, Qoder, Qoder CN, Qwen Code, QwenPaw, Reasonix, Trae CLI 등 22개 코딩 도구를 기본 지원합니다. 데몬이 이미 설치된 CLI를 자동으로 찾아 각각 런타임으로 등록합니다. Prime Agent 연동은 카탈로그에 있지만 upstream이 장기 실행 기능을 강제로 비활성화하는 managed mode를 제공할 때까지 이 수에 포함되지 않으며 실행할 수 없습니다.",
        },
        {
