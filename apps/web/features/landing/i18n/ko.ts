      ...
      entries: [
        {
          version: "0.4.16",
          date: "2026-07-31",
          title: "더 빨라진 작업, 선명한 링크, 강력해진 에이전트",
          changes: [],
          features: [
            "채팅 답변에서 다음 작업을 한 번에 시작할 수 있습니다.",
            "Issue에 에이전트와 프롬프트를 저장하고 한 번에 실행할 수 있습니다.",
            "Multica Issue와 프로젝트 링크가 클릭 가능한 칩으로 표시됩니다.",
            "나중에 볼 알림을 읽지 않음으로 표시할 수 있습니다.",
            "에이전트에 이모지 아바타를 정하고 사용 중인 런타임도 볼 수 있습니다.",
            "Qoder CN을 Multica 런타임으로 사용할 수 있습니다.",
          ],
          improvements: [
            "대규모 셀프 호스팅 워크스페이스를 더 빠르게 삭제할 수 있습니다.",
            "에이전트와 스킬의 리소스 라벨을 항상 사용할 수 있습니다.",
            "Linux Codex 작업이 데몬 계정의 환경을 사용합니다.",
            "기본 제공 스킬 이름이 더 명확하고 일관되게 바뀌었습니다.",
            "Multica 전체의 텍스트가 더 선명하고 일관되게 바뀌었습니다.",
          ],
          fixes: [
            "Windows에서 Copilot의 여러 줄 프롬프트가 올바르게 작동합니다.",
            "긴 에이전트 답변의 마지막 업데이트가 더 이상 사라지지 않습니다.",
            "타임라인에서 최신 활동을 계속 확인할 수 있습니다.",
            "에이전트가 하위 Issue를 만들면 구독자에게 알립니다.",
            "셀프 호스팅 배포에서 올바른 백엔드 포트를 사용합니다.",
            "사용량 순위가 집계 합계와 일치합니다.",
            "필터링한 Issue에는 실제로 작업 중인 에이전트만 집계됩니다.",
            "WebSocket 연결이 지나치게 큰 메시지를 거부합니다.",
            "셀프 호스팅 업그레이드가 중복 마이그레이션에서 멈추지 않습니다.",
            "온보딩을 나가서 처음부터 다시 시작할 수 있습니다.",
          ],
        },
        {
          version: "0.4.15",
