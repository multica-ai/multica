      ...
      entries: [
        {
          version: "0.3.24",
          date: "2026-06-17",
          title: "사용자 지정 런타임 프로필과 더 명확한 에이전트 설정",
          changes: [],
          features: [
            "팀은 이제 사용자 지정 런타임 프로필을 만들어 에이전트가 각 환경에 맞는 로컬 도구, 모델 선택지, 작업 설정을 사용할 수 있습니다.",
            "명령줄에서 에이전트를 만들거나 업데이트할 때 사고 수준을 선택할 수 있어 작업 난이도에 맞게 추론 깊이를 조정하기 쉬워졌습니다.",
          ],
          improvements: [
            "새로 만들거나 수정한 런타임 프로필이 앱에 더 빠르게 나타나고, 에이전트는 현재 환경에 가장 잘 맞는 프로필을 우선 사용합니다.",
            "클라이언트 오류와 멈춤 보고가 중복으로 쌓이기 전에 묶여 더 조용하고 검토하기 쉬워졌습니다.",
            "Issue 댓글 트리거 미리보기 문구가 더 명확해져 댓글을 게시한 뒤 어떤 에이전트나 스쿼드가 시작될지 보기 쉽습니다.",
          ],
          fixes: [
            "Office 365 메일은 첫 번째 로그인 방식이 사용할 수 없을 때도 더 안정적으로 전송됩니다.",
            "GitHub 연동은 설치 맥락을 더 안정적으로 유지하고, CI가 아직 실행 중일 때 대기 중인 검사를 표시합니다.",
            "Codex 실행에 필요한 서비스가 종료되면 빠르게 실패해 애매한 대기 상태를 줄입니다.",
            "런타임 소유자는 셀프 힐링 런타임을 다시 삭제할 수 있으며, 런타임을 바꿀 때 맞지 않는 모델 선택은 자동으로 정리됩니다.",
            "Issue 화면은 알 수 없는 아이콘을 안전하게 처리하고, 댓글의 일반 파일 이름이 실수로 외부 링크가 되지 않습니다.",
          ],
        },
        {
          version: "0.3.23",
