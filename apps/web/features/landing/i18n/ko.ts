      ...
      entries: [
        {
          version: "0.5.0",
          date: "2026-09-08",
          title: "댓글 스레드 안의 에이전트 실행 표시, 스레드별 대기열, 더 안정적인 세션, 줄어든 검색 타임아웃",
          changes: [],
          features: [
            "에이전트의 대기, 실행 단계, 중지와 재시도, 전체 로그가 시작한 댓글 스레드 안에 표시됩니다.",
            "루트 댓글 스레드마다 태스크가 따로 진행되어 다른 논의가 섞이거나 답변이 사라지지 않습니다.",
            "댓글 스레드 목록이 오른쪽으로 옮겨지고 긴 제목도 그대로 읽힙니다.",
          ],
          improvements: [
            "빠른 생성으로 시작한 태스크는 Issue 활동 기록을 채우지 않고 실행 기록에서 볼 수 있어요.",
            "복잡한 검색이 중간에 실패하지 않고, 댓글 검색도 더 빨라졌어요.",
          ],
          fixes: [
            "DingTalk에서 인용 답장으로 /new나 /clear를 보내도 인용과 지시가 섞이지 않습니다.",
            "Lark DM으로 연동 카드를 보낼 수 없을 때 그룹에 이유를 알려 줍니다.",
            "Telegram에서 같은 답변이 두 번 오지 않습니다.",
            "중간에 멈춘 Codex 실행도 사용한 토큰이 기록됩니다.",
            "qoder, kiro, grok, kimi 등에서 멈춘 대화가 다음 메시지에 다시 이어집니다.",
            "Lark에서 만든 Issue 링크가 알맞은 워크스페이스에서 열립니다.",
            "Cursor 태스크가 서비스를 띄워 둔 채여도 완료된 것처럼 보이거나 멈추지 않습니다.",
            "Issue 분할 화면에 사이드바 토글이 두 개 나오지 않고, AI Team 표기도 바르게 나옵니다.",
          ],
        },
        {
          version: "0.4.41",
