      ...
      entries: [
        {
          ...
          features: [
            ...
            "도구 출력이 앞부분만 남았을 때 실행 세부 정보에 그 사실이 표시됩니다.",
          ],
          improvements: [
          ...
          fixes: [
            "Lark 일반 그룹에서 에이전트 답장이 질문을 인용하고 질문한 사람을 멘션합니다.",
            "여러 사람이 동시에 물어도 다른 사람을 멘션하지 않습니다.",
            "Analytics와 명령줄이 보고되지 않은 사용량과 실제 0원 지출을 구분합니다.",
            "사용량 데이터가 일부만 있으면 최소값임을 알려 줍니다.",
