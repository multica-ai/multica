    ...
    entries: [
      {
        version: "0.4.16",
        date: "2026-07-31",
        title: "更快的操作、更清晰的链接和更强的智能体",
        changes: [],
        features: [
          "聊天回复现在会提供一键继续的建议。",
          "Issue 现在支持保存智能体和提示词，一键运行。",
          "直接粘贴 Multica 的 Issue 或项目链接，现会显示为可点击卡片。",
          "通知现在可标为未读，方便稍后处理。",
          "智能体现在支持自选 emoji 头像，也能显示所用运行时。",
          "现在可以将 Qoder CN 用作 Multica 运行时。",
        ],
        improvements: [
          "大型自托管工作区现在可以更快删除。",
          "智能体和 Skill 的资源标签现在始终可用。",
          "Linux 上的 Codex 任务现在使用守护进程账户环境。",
          "内置 Skill 现在使用清晰一致的名称。",
          "Multica 的文字现在更清晰、更一致。",
        ],
        fixes: [
          "Windows 上的 Copilot 现在可正确处理多行提示词。",
          "智能体的长回复不再丢失最后的更新。",
          "时间线现在会保留最新活动。",
          "智能体创建子 Issue 时，订阅者现在会收到通知。",
          "自托管部署现在会使用正确的后端端口。",
          "用量排行榜现在会与汇总数据一致。",
          "筛选后的 Issue 现在只统计实际在其中工作的智能体。",
          "WebSocket 连接现在会拒绝过大的消息。",
          "自托管升级不再因重复迁移而中断。",
          "引导页现在可以退出并重新开始。",
        ],
      },
