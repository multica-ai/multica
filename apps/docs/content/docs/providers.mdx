...
"Multica-managed MCP" records execution compatibility for retained configurations. New MCP setup belongs in the tool's native runtime configuration or the independent workspace MCP library.
