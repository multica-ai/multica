...
|---|---|---|---|---|
| Installation | Generate a QR code in Multica and authorize by scanning it with Feishu | Generate a QR code in Multica and authorize by scanning it with WeCom — each scan creates a new smart bot | Create an app in Slack, then paste two tokens into Multica | Create an internal app and Stream-mode robot, then paste its AppKey and AppSecret into Multica |
