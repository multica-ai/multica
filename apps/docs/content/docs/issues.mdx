...
A workspace owner or admin can add statuses under **Settings → Statuses & transitions** — `Code Review`, `QA`, `Rework`. Every status belongs to one of four lifecycle categories:
