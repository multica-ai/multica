...
- ✅ **真支持**——Antigravity、Claude Code、Codex、Copilot、Cursor、Hermes、Kimi、Kiro CLI、OpenCode、OpenClaw、Pi、ForgeCode
- ❌ **不支持**——Gemini
...
- [Providers Matrix](/providers) —— 13 款 AI 编程工具的能力差异对照（包括会话恢复的精确状态）
