...
Select a model to see its prices immediately. Workspace owners and admins can choose **Customize**, edit the rates, then **Save changes**. **Pricing details** contains the update schedule and manual refresh.

Subscription estimates show the API-equivalent value of your usage, not your subscription bill. Price changes apply across the workspace and recalculate past estimates in usage reports. Provider-reported costs stay unchanged. See [Model pricing](/developers/model-pricing) for details.
