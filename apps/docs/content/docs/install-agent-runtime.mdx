...
The most complete integration. Session resumption works, MCP works, and it's the **only one of the 15 that actually consumes the `mcp_config` field** on agents (see the [matrix](/providers#mcp-configuration-only-claude-code-actually-reads-it)).
