...
| MiniMax Code | `mcode` | [MiniMax Code](https://github.com/MiniMax-AI/minimax-code) |
...
For MiniMax Code, run `mcode login` first. MiniMax Code owns the model selection; Multica cannot override it through ACP.
