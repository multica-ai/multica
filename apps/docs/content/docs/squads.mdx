...
To copy a squad and the agents on its roster from another workspace you belong to, use **Import** on the Squads page. See [Workspaces](/workspaces#import-agents-and-squads).
