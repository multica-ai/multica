...
If you send a question and then mention the Bot separately, it uses up to three immediately preceding messages from you within five minutes. Another speaker, a bot reply, or an earlier mention ends that selection. If the intended message is unclear, it asks. Earlier discussion remains reference material rather than a new queue of questions. Quote an older message or explicitly ask for a recap when you want to revisit it.
