---
title: Contributing
description: Local development workflow for contributors working on the Wallts codebase.
---
...
| | Main | Worktree |
|---|---|---|
| Database | `wallts` | `wallts_my_feature_702` |
...
```bash
docker compose exec -T postgres psql -U wallts -d postgres \
