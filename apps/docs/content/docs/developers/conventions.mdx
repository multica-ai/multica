...
| Entity                                          | en      | zh-Hans  | ja         | ko         | fr            | es             |
| ----------------------------------------------- | ------- | -------- | ---------- | ---------- | ------------- | -------------- |
| the tracked unit of work (`issue`)              | Issue   | **任务** | **タスク** | **태스크** | **Tâche**     | **Incidencia** |
| one agent execution record (`task` in API / DB) | **Run** | **运行** | **実行**   | **실행**   | **Exécution** | **Ejecución**  |
