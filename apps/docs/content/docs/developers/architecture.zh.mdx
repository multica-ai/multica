---
title: Architecture
description: Technical architecture of the Wallts platform.
---

## Overview

Wallts is a Go backend + monorepo frontend (pnpm workspaces + Turborepo) with shared packages.
...
- **Entry points** (`cmd/`): `server` (HTTP API), `wallts` (CLI + daemon), `migrate`
