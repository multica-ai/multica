...
Place features shared by browser hosts according to responsibility:
...
4. Keep framework-specific routing adapters in the corresponding app.
5. Wire shared pages into the browser hosts that use them.
...
| Browser-host platform wiring | Corresponding `apps/*` directory |
