...
| `MULTICA_TASK_CONFIG_PROVIDER_REF_PREFIXES` | 비어 있음(비활성화) | 프로젝트 `task_config` 리소스의 control-plane provider reference 접두사 allowlist(쉼표로 구분). workspace owner/admin만 바인딩을 관리할 수 있으며 비워 두면 기능이 비활성화됨 |
