...
<NumberedCards>
  ...
  <NumberedCard number="03" title="桌面应用" href="/desktop-app" tag="推荐">
    原生多标签窗口。内置命令行工具并在你登录后自动拉起守护进程——安装后无需运行任何命令即可使用。可连接 Multica Cloud 或你自部署的后端。
  </NumberedCard>
</NumberedCards>
