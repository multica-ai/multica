...
此外还提供一个纯后端的实验性[千问 skill 桥接](/qianwen-skill-integration)，用于夸克 S1 私有 skill。它通过异步提交和状态轮询工具工作，而不是建立长期 Bot 连接；目前不支持向眼镜主动推送消息。
...
- [Slack Bot 接入](/slack-bot-integration)
- [钉钉 Bot 接入](/dingtalk-bot-integration)
- [千问 skill 桥接（实验性）](/qianwen-skill-integration) — 从夸克 S1 私有 skill 提交请求并轮询结果；目前不支持主动推送。
- [与智能体对话](/chat)
