...
|---|---|---|
| `DATABASE_URL` | unset in Docker Compose; server binary falls back to `postgres://multica:multica@localhost:5432/multica?sslmode=disable` | **Yes** outside the bundled Compose database |
