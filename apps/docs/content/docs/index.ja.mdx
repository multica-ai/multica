...
<NumberedCards>
  ...
  <NumberedCard number="03" title="デスクトップアプリ" href="/desktop-app" tag="推奨">
    ネイティブのマルチタブウィンドウ。CLI が内蔵されており、サインイン後にデーモンを自動的に開始します。インストール後に実行するコマンドは一切ありません。Multica Cloud またはセルフホストのバックエンドに接続します。
  </NumberedCard>
</NumberedCards>
