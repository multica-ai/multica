...
실험적인 [Qianwen Skill 브리지](/qianwen-skill-integration)를 사용해 Quark S1의 비공개 Skill을 연결할 수 있습니다. Web/Desktop 공용 Settings 카드는 Multica 측 installation을 만들고 현재 사용자 자신의 신원 페어링을 관리하며, 공급자 측 Skill 및 기기 설정은 별개입니다. 서명된 Tool로 작업을 제출하고 개별 결과를 폴링하거나 연결된 사용자가 볼 수 있는 미종료 작업을 나열할 수 있습니다. 이 브리지는 pull 전용이며 실제 Qianwen Tool과 S1에서의 스모크 테스트가 여전히 필요합니다. 업계용 메시지 푸시는 별도의 기업 비즈니스 온보딩 경로이며 이 폴링 연동의 전제 조건이 아닙니다. 일반 소매용 S1 비공개 Skill이 대상인지도 확인되지 않았습니다.
...
- [Qianwen Skill 브리지(실험적)](/qianwen-skill-integration) — 비공개 Quark S1 Skill 페어링, 서명된 요청 제출, 결과 폴링 및 현재 작업 조회. 기기로의 능동 푸시는 지원하지 않습니다.
...
4. 메시지가 [에이전트 대화](/chat)에 들어가고 실행 작업이 하나 생성됩니다.
...
- [Slack Bot 연결](/slack-bot-integration)
- [DingTalk Bot 연결](/dingtalk-bot-integration)
- [Qianwen Skill 브리지(실험적)](/qianwen-skill-integration)
- [에이전트와 대화](/chat)
