...
The CLI install is the same as in [Cloud quickstart → 2. Install the CLI](/cloud-quickstart#2-install-the-cs-workflow-cli) — Homebrew / script / PowerShell, pick one.
