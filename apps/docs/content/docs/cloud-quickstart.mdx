...
<Callout type="info">
**Using the desktop app?** The desktop app **starts the daemon automatically** on launch — no need to run `cs-workflow setup` by hand. See [Desktop app](/desktop-app).
</Callout>
