...
LATEST=$(curl -sI https://github.com/kanfashidoufu/multica/releases/latest \
  | grep -i '^location:' | sed 's/.*tag\///' | tr -d '\r\n')

# Download and extract
curl -sL "https://github.com/kanfashidoufu/multica/releases/download/${LATEST}/multica_${OS}_${ARCH}.tar.gz" \
