...
**PR automation policy:** Workspaces that have migrated use [two explicit settings](/pr-automation) for linking and completion. The keyword-based linking/completion rules below apply only to workspaces that have not migrated.
