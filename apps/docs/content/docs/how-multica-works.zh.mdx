...
description: 三个核心组件（server / 守护进程 / AI 编程工具）怎么协同完成一次数字员工工作。
---
...
以"你把一个 issue 分配给某个数字员工"这个最常见的场景为例：
...
| 方式 | 典型场景 | 文档 |
|---|---|---|
| **分配 issue** | 最常见。把一条 issue 指派给数字员工，它自动开工 | [分配 issue](/assigning-issues) |
| **在评论里 @数字员工** | "这条你帮我看一下"——不改 assignee、不改状态，用一条评论触发 | [在评论里 @数字员工](/mentioning-agents) |
