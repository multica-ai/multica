...
| **Files** | Artifacts produced or uploaded across the project, viewable in the sidebar. |
...
The project's **Files** panel in the sidebar lists every artifact a member or an agent produced or uploaded across the project: files on its issues, on comments of those issues, and on chat sessions linked to the project.

- **View** a file to preview it in place — markdown, code, images, PDFs, and more. Press `Esc` to close the preview.
- **Download** to save a copy.
- **Hide** to remove a file from your list. Hiding is personal: it only changes your view, and other members still see the file. Use **Show hidden** to bring hidden files back.

The same file is listed once even if it was attached to both an issue and a comment.
