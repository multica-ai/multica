...
- ✅ **Real support** — Antigravity, Claude Code, Codex, Copilot, Cursor, Hermes, Kimi, Kiro CLI, OpenCode, OpenClaw, Pi, ForgeCode
- ❌ **No support** — Gemini
...
- [Providers Matrix](/providers) — capability differences across the 13 AI coding tools (including the exact session-resumption status)
