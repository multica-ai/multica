...
Un propriétaire ou un administrateur de l'espace de travail peut ajouter des statuts dans **Paramètres → États et transitions** — `Code Review`, `QA`, `Rework`. Chaque statut appartient à l'une des quatre catégories de cycle de vie :
