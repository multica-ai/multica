...
The installed app connects to Multica Cloud by default; sign in with your existing account. Workspaces, issues, comments, and run history all live on the server — nothing needs to be synced manually from the web.
...
- [CLI](/cli) — connect local and remote runtimes.
