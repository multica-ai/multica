...
Wallts's iOS client is open-source and lives in the [main repo](https://github.com/dwickyfp/wallts) alongside web, desktop, and backend. It isn't on the App Store yet — until that changes, anyone who wants it on their iPhone builds from source. The build takes about 10–20 minutes the first time and ~2 minutes after that, and it talks to the same backend as [wallts.ai](https://wallts.ai) so your existing account just works.

<Callout type="info">
This page is for **personal use**. App developers should read [`apps/mobile/README.md`](https://github.com/dwickyfp/wallts/blob/main/apps/mobile/README.md) in the repo — it covers the dev / staging variants and the full script matrix.
</Callout>
...
If you'd like to be notified when TestFlight opens, watch the [GitHub repo](https://github.com/dwickyfp/wallts).
