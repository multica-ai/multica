...
| **Concurrency limit** | Controls how many tasks the agent can run at the same time. |
...
- [Create and configure an agent](/agents-create) — create one manually and choose its runtime.
