...
postgres_db="wallts_${slug}_${offset}"
postgres_port=5432
...
DATABASE_URL=postgres://wallts:wallts@localhost:${postgres_port}/${postgres_db}?sslmode=disable

PORT=${backend_port}
JWT_SECRET=change-me-in-production
WALLTS_DEV_VERIFICATION_CODE=888888
WALLTS_SERVER_URL=ws://localhost:${backend_port}/ws
