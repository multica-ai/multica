...
#   $env:MULTICA_MODE="local"; irm https://raw.githubusercontent.com/kanfashidoufu/multica/main/scripts/install.ps1 | iex
#
...
# Configuration
# ---------------------------------------------------------------------------
$RepoUrl       = "https://github.com/kanfashidoufu/multica.git"
$RepoWebUrl    = "https://github.com/kanfashidoufu/multica"
...
function Get-LatestVersion {
    try {
        $release = Invoke-RestMethod -Uri "https://api.github.com/repos/kanfashidoufu/multica/releases/latest" -ErrorAction Stop
...
function Install-CliBinary {
    ...
    $url = "https://github.com/kanfashidoufu/multica/releases/download/$latest/multica-cli-$version-windows-$arch.zip"
    ...
    $checksumUrl = "https://github.com/kanfashidoufu/multica/releases/download/$latest/checksums.txt"
    try {
...
function Start-DefaultInstall {
    ...
    Write-Host '     $env:MULTICA_MODE="with-server"; irm https://raw.githubusercontent.com/kanfashidoufu/multica/main/scripts/install.ps1 | iex'
    Write-Host ""
}
...
function Start-LocalInstall {
    ...
    Write-Host '     $env:MULTICA_MODE="stop"; irm https://raw.githubusercontent.com/kanfashidoufu/multica/main/scripts/install.ps1 | iex'
    Write-Host ""
}
