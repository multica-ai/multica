...
# Configuration
# ---------------------------------------------------------------------------
$RepoUrl       = "https://github.com/Askhz/multica.git"
$RepoWebUrl    = "https://github.com/Askhz/multica"
...
function Get-LatestVersion {
    try {
        $release = Invoke-RestMethod -Uri "https://api.github.com/repos/Askhz/multica/releases/latest" -ErrorAction Stop
...
function Install-CliBinary {
    ...
    $checksumUrl = "https://github.com/Askhz/multica/releases/download/$latest/checksums.txt"
    try {
