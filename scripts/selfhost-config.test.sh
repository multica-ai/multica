...
require_config "$config" 'DATABASE_REPLICA_PROBE_INTERVAL: 3s'
require_config "$config" 'DATABASE_REPLICA_PROBE_TIMEOUT: 750ms'
require_config "$config" 'DATABASE_REPLICA_MAX_REPLAY_LAG: 8s'
